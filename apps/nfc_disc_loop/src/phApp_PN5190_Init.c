...
phApp_ConfigureLPCD(void)
{
  ...
  status = phhalHw_Pn5190_Instr_LPCD_SetConfig(pHal, PHHAL_HW_CONFIG_LPCD_MODE,
          PHHAL_HW_PN5190_LPCD_MODE_DEFAULT);
  CHECK_SUCCESS(status);

  status = phhalHw_Pn5190_Instr_LPCD_SetConfig(pHal, PHHAL_HW_CONFIG_LPCD_CONFIG,
