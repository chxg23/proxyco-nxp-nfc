...
phStatus_t phNfcLib_ISO18000_Transmit(void *const pTxBuffer, uint16_t wTxBufferLength)
{
...
#if 0
  ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.wUiiMaskLength % 8U) != 0U) ?
  (bUiiMaskBytes = (((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.wUiiMaskLength) / 8U) +
              1U)) : (bUiiMaskBytes = (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.wUiiMaskLength) /
                      8U);
  ...
  if (0 != (memcmp(gphNfcLib_State.pActivatedUid,
              ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pUii, bUiiMaskBytes))) {
    ...
    (void)memcpy(&gphNfcLib_Params.salI18000p3m3.abHandle[0],
        &gphNfcLib_State.pRxBuffer[gphNfcLib_State.wRxLength - 2u], 2);
  ...
  switch (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bCommand) {
    case ISO18000_Ack:
      ...
      /* Build Command frame */
      bCmd[0] = (PH_NFCLIB_18000P3M3_CMD_ACK << 6U) | (gphNfcLib_Params.salI18000p3m3.abHandle[0] >>
              2U);    /* 0 bits left */
      bCmd[1] = (gphNfcLib_Params.salI18000p3m3.abHandle[0] << 6U) |
          (gphNfcLib_Params.salI18000p3m3.abHandle[1] >> 2U);                    /* 0 bits left */
      ...
      statusTmp = phNfcLib_18000p3m3_Exchange(PH_NFCLIB_18000P3M3_SKIP_COMMAND, 0x02,
              PH_NFCLIB_18000P3M3_SKIP_COMMAND, &bCmd[0], 3, &wRxLastBits);
      ...
      /* set Tx-CRC as CRC16  */
      (void)phhalHw_SetConfig(gphNfcLib_Params.sDiscLoop.pHalDataParams, PHHAL_HW_CONFIG_CRCTYPE,
    ...
    case ISO18000_Read:
      ...
      /* append pointer */
      for (bIndex = 0;
          bIndex < (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bWordPtrLength + 1U); ++bIndex) {
        bCmd[wCmdLength++] |= (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pWordPtr[bIndex]) >>
            4U;
        bCmd[wCmdLength]    = (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pWordPtr[bIndex]) <<
            4U;
      }
      ...
      /* append word-count */
      bCmd[wCmdLength++] |= ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bWordCount >>
          4U;  /* 0 bits left */
      bCmd[wCmdLength]    = ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bWordCount <<
          4U;  /* 4 bits left */
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phNfcLib_18000p3m3_Exchange(PH_OFF, 0x04,
              PH_NFCLIB_18000P3M3_SKIP_COMMAND, &bCmd[0], wCmdLength, &wRxLastBits));

      /* Check received length and header bit */
      if (((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bWordCount != 0x00U) &&
              (gphNfcLib_State.wRxLength != ((((uint16_t)(((phNfcLib_Transmit_t *)
                                      pTxBuffer)->phNfcLib_ISO18000.bWordCount)) << 1U) + 3U))) ||
      ...
      /* TODO: if ever the handle concept changes the change has to be done here */
      /* Check Handle */
      if ((gphNfcLib_State.pRxBuffer[gphNfcLib_State.wRxLength - 2u] !=
              gphNfcLib_Params.salI18000p3m3.abHandle[0]) ||
          (gphNfcLib_State.pRxBuffer[gphNfcLib_State.wRxLength - 1u] !=
              gphNfcLib_Params.salI18000p3m3.abHandle[1])) {
        return PH_ERR_PROTOCOL_ERROR;
      }
    ...
    case ISO18000_Write:
      ...
      if ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bMemBank  > 0x03U) ||
          (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bWordPtrLength > 3U) ||
          ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bOption !=
                  PH_NFCLIB_18000P3M3_AC_NO_COVER_CODING) &&
              (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bOption !=
                  PH_NFCLIB_18000P3M3_AC_USE_COVER_CODING))) {
        return PH_ERR_INVALID_PARAMETER;
      }
      ...
      /* append data */
      bCmd[wCmdLength++] |= ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pBuffer[0] >>
          4U;                        /* 0 bits left */
      bCmd[wCmdLength++]  = (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pBuffer[0] << 4U) |
          (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pBuffer[1] >>
              4U);                      /* 0 bits left */
      bCmd[wCmdLength]    = ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pBuffer[1] <<
          4U;                        /* 4 bits left */

      /* perform cover-coding if neccessary */
      if (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bOption ==
          PH_NFCLIB_18000P3M3_AC_USE_COVER_CODING) {
        ...
        bCmd[wCmdLength - 1u] ^= (gphNfcLib_State.pRxBuffer[0] << 4U) | (gphNfcLib_State.pRxBuffer[1] >>
                4U);
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phNfcLib_18000p3m3_Exchange(PH_OFF, 0x04, 5, &bCmd[0], wCmdLength,
              &wRxLastBits));

      /* Check header bit */
      if ((gphNfcLib_State.wRxLength != 3U) || (wRxLastBits != 1U) ||
          ((gphNfcLib_State.pRxBuffer[0] & 0x80U) != 0U)) {
        return PH_ERR_PROTOCOL_ERROR;
      }

      /* Check Handle */
      bHandle[0] = (uint8_t)((gphNfcLib_State.pRxBuffer[0] << 1U) | (gphNfcLib_State.pRxBuffer[1] >>
                  7U));
      bHandle[1] = (uint8_t)((gphNfcLib_State.pRxBuffer[1] << 1U) | (gphNfcLib_State.pRxBuffer[2] >>
                  7U));
    ...
    case ISO18000_Kill:
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phNfcLib_18000p3m3_Exchange(PH_OFF, 0x03, 500, &bCmd[0], 6,
              NULL));
      ...
      */
      ...
      /* append RFU/Recom bits (000) and handle */
      bCmd[3]  = ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bRecom <<
          5U;                     /* 5 bits left */
      bCmd[3] |= gphNfcLib_Params.salI18000p3m3.abHandle[0] >> 3U;   /* 0 bits left */
      bCmd[4]  = gphNfcLib_Params.salI18000p3m3.abHandle[0] << 5U;   /* 5 bits left */
      bCmd[4] |= gphNfcLib_Params.salI18000p3m3.abHandle[1] >> 3U;   /* 0 bits left */
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phNfcLib_18000p3m3_Exchange(PH_OFF, 0x03,
              PH_NFCLIB_18000P3M3_SKIP_COMMAND, &bCmd[0], 6, &wRxLastBits));
    ...
    case ISO18000_Lock:
      ...
      bCmd[1] = ((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_ISO18000.pMask[0];                                                     /* 0 bits left */
      bCmd[2] = (uint8_t)((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pMask[1] & 0xC0U) | (((
                          phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pAction[0] >>
                  2U));             /* 0 bits left */
      bCmd[3] = (uint8_t)((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pAction[0] << 6U)
              | ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pAction[1] & 0xC0U) >>
                  2U));    /* 4 bits left */
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phNfcLib_18000p3m3_Exchange(PH_OFF, 0x04, 5, &bCmd[0], 6,
              &wRxLastBits));
    ...
    case ISO18000_Access:
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phNfcLib_18000p3m3_Exchange(PH_OFF,
              PH_NFCLIB_18000P3M3_SKIP_COMMAND, PH_NFCLIB_18000P3M3_SKIP_COMMAND, &bCmd[0], 5, NULL));
    ...
    case ISO18000_BlockWrite:
      ...
      /* append data */
      for (bIndex = 0;
          bIndex < (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bWordCount << 1U); ++bIndex) {
        bCmd[wCmdLength++] |= ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pBuffer[bIndex] >>
            4U;  /* 0 bits left */
    ...
    case ISO18000_BlockErase:
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phNfcLib_18000p3m3_Exchange(PH_ON, 0x04, 20, &bCmd[0], wCmdLength,
              &wRxLastBits));
    ...
    case ISO18000_BlockPermaLock:
      ...
      if ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bReadLock > 0x01U) ||
          (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bMemBank > 0x03U) ||
          (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bBlockPtrLength > 3U)) {
        return PH_ERR_INVALID_PARAMETER;
      }
      ...
      bCmd[wCmdLength]   = (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bReadLock << 7U) | (((
                      phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bMemBank << 5U) | (((
                      phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bBlockPtrLength << 3U);  /* 3 bits left */

      /* append pointer */
      for (bIndex = 0;
          bIndex < (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bBlockPtrLength + 1U); ++bIndex) {
        bCmd[wCmdLength++] |= (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pBlockPtr[bIndex]) >>
            5U;
        bCmd[wCmdLength]    = (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pBlockPtr[bIndex]) <<
            3U;
      }
      ...
      bCmd[wCmdLength++] |= ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bBlockRange >>
          5U;  /* 0 bits left */
      ...
      if (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bReadLock == 0x01U) {
        for (bIndex = 0;
            bIndex < (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bBlockRange << 1U); ++bIndex) {
          bCmd[wCmdLength++] |= ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pMask[bIndex] >>
              5U;  /* 0 bits left */
      ...
      (void)phNfcLib_18000p3m3_Exchange(PH_OFF, 0x05, 500, NULL, PH_NFCLIB_18000P3M3_SKIP_COMMAND,
          NULL);
      ...
      if (statusTmp == PH_ERR_SUCCESS) {
        ...
        if (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.bReadLock == 0x00U) {
          if (gphNfcLib_State.wRxLength != (3u + (((uint16_t)(((phNfcLib_Transmit_t *)
                                  pTxBuffer)->phNfcLib_ISO18000.bBlockRange)) << 1U))) {
            return PH_ERR_PROTOCOL_ERROR;
          }
        } else {
          if (gphNfcLib_State.wRxLength != 3U) {
    ...
    case ISO18000_SetHandle:
      (void)memcpy(&gphNfcLib_Params.salI18000p3m3.abHandle[0],
          &((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO18000.pHandle[0], 2);
      gphNfcLib_Params.salI18000p3m3.bHandleValid = PH_ON;
      statusTmp = PH_ERR_SUCCESS;
      break;
