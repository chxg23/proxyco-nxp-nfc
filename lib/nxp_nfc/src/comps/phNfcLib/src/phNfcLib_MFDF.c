  ...
  switch (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.bCommand) {
    ...
    case MFDF_Create_Application:
      ...
      */
      ...
      if ((((phNfcLib_Transmit_t *)
                  pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.bISODFNameLen > 16U) ||
          (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.bOptions
              > 0x03U) ||
          (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.bOptions
              == 0x02U)) {
      ...
      (void)memcpy(&aCommand[wCmdLen],
          &((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.pApplicationIdentifier[0], 3);
      wCmdLen += 3U;

      aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.bKeySettings1;
      aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.bKeySettings2;

      if (0u != (((phNfcLib_Transmit_t *)
                  pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.bOptions & 0x01U)) {
        /* wISOFileId is present */
        aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
                pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.pISOFileId[0];
        aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
                pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.pISOFileId[1];
      }
      if (0u != (((phNfcLib_Transmit_t *)
                  pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.bOptions & 0x02U)) {
        /* pISODFName is present */
        (void)memcpy(&aCommand[wCmdLen],
            ((phNfcLib_Transmit_t *)
                pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.pISODFName,
            ((phNfcLib_Transmit_t *)
                pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.bISODFNameLen);
        wCmdLen = wCmdLen + ((phNfcLib_Transmit_t *)
                pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_Application.bISODFNameLen;
      }
    ...
    case MFDF_Select_Application:
      ...
      (void)memcpy(&aCommand[1], &((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_Application.pApplicationIdentifier[0],
          PH_NFCLIB_MFDF_DFAPPID_SIZE);
    ...
    case MFDF_Create_StdDataFile:
      ...
      if ((((phNfcLib_Transmit_t *)
                  pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.bFileNo > 0x1fU) ||
          (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.bOption >
              0x01U)) {
        return PH_ERR_INVALID_PARAMETER;
      }

      if (((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.bCommSett !=
          PH_NFCLIB_MFDF_COMMUNICATION_PLAIN) {
        return PH_ERR_INVALID_PARAMETER;
      }
      ...
      /* File Number */
      aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.bFileNo;

      /* Copy ISO Filed ID if present */
      if (((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.bOption == 0x01U) {
        aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
                pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.pISOFileId[0];
        aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
                pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.pISOFileId[1];
      }

      /* Copy communication settings. communication settings in the first nibble so right shifting */
      aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.bCommSett >> 4U;

      /* Copy Access rights */
      aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.pAccessRights[0];
      aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.pAccessRights[1];

      /* Copy File size supplied by the user */
      (void)memcpy(&aCommand[wCmdLen],
          &((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Create_StdDataFile.pFileSize[0], 3);
      wCmdLen += 3U;
    ...
    case MFDF_Write_Data:
      ...
      if (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Write_Data.bFileNo >
          0x1fU) {
        return PH_ERR_INVALID_PARAMETER;
      }

      if (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Write_Data.bCommOption !=
          PH_NFCLIB_MFDF_COMMUNICATION_PLAIN) {
      ...
      aCommand[wCmdLen++] = ((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Write_Data.bFileNo;
      (void)memcpy(&aCommand[wCmdLen],
          &((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Write_Data.pOffset[0], 3);
      wCmdLen += 3U;
      (void)memcpy(&aCommand[wCmdLen],
          &((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Write_Data.pTxDataLen[0],
          3);
      wCmdLen += 3U;

      /* Assuming here that the size can never go beyond FFFF.
      In fact it can never go beyond 8092 (1F9C) bytes */
      wDataLen = (uint16_t)((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Write_Data.pTxDataLen[1];
      wDataLen = wDataLen << 8U;
      wDataLen |= ((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Write_Data.pTxDataLen[0];
    ...
    case MFDF_Iso_SelectFile:
      ...
      if (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_File.bDFnameLen >
          16U) {
        return PH_ERR_INVALID_PARAMETER;
      }
      if ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_File.bOption !=
              0x00U) && (((phNfcLib_Transmit_t *)
                  pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_File.bOption != 0x0CU)) {
        return PH_ERR_INVALID_PARAMETER;
      }

      switch (((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_File.bSelector) {
        case 0x00:
        case 0x02:
          /* Selection by EF Id*/
          /* Send MSB first to card */
          aCommand[0] = ((phNfcLib_Transmit_t *)
                  pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_File.pFid[1];
          aCommand[1] = ((phNfcLib_Transmit_t *)
                  pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_File.pFid[0];
          bLc = 2;
          break;

        case 0x04:
          /* Selection by DF Name */
          (void)memcpy(aCommand, ((phNfcLib_Transmit_t *)
                  pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_File.pDFname,
              ((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_File.bDFnameLen);
      ...
      return  phNfcLib_MFDF_Send7816Apdu(
              (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Select_File.bOption ==
                  0x0CU) ? 0x01U : 0x03U,             /* As per Table 40-P2 in ISO/IEC FDIS 7816-4 */
    ...
    case MFDF_Iso_ReadBinary:
      ...
      if (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Read_Binary.wOption ==
          PH_EXCHANGE_DEFAULT) {
        if (0U != (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Read_Binary.bSfid
                & 0x80U)) {
          /* Short file id is supplied */
          if ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Read_Binary.bSfid &
                  0x7FU) > 0x1FU) {
            /* Error condition */
            return PH_ERR_INVALID_PARAMETER;
          }
        ...
        bLe = ((phNfcLib_Transmit_t *)
                pTxBuffer)->phNfcLib_MifareDesfire.Operation.Read_Binary.bBytesToRead;
      ...
      } else if (((phNfcLib_Transmit_t *)
              pTxBuffer)->phNfcLib_MifareDesfire.Operation.Read_Binary.wOption == PH_EXCHANGE_RXCHAINING) {
        wCmdLen = 0;
      } else {
        return PH_ERR_INVALID_PARAMETER;
      }
    ...
    case MFDF_Iso_UpdateBinary:
      ...
      if (0u != (((phNfcLib_Transmit_t *)
                  pTxBuffer)->phNfcLib_MifareDesfire.Operation.Update_Binary.bSfid & 0x80U)) {
        /* Short file id is supplied */
        if ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareDesfire.Operation.Update_Binary.bSfid &
                0x7FU) > 0x1FU) {
          /* Error condition */
          return PH_ERR_INVALID_PARAMETER;
        }
...
#if 0
          statusTmp = ((statusTmp == PH_NFCLIB_MFDF_RESP_ADDITIONAL_FRAME) ? PH_ERR_SUCCESS_CHAINING :
    ...
    uint16_t wCmdLen,  uint8_t **ppResponse, uint16_t *pRxlen)
{
  ...
  if ((statusTmp != PH_NFCLIB_MFDF_RESP_OPERATION_OK) &&
      (statusTmp != PH_NFCLIB_MFDF_ISO7816_SUCCESS)) {
    if (statusTmp == PH_NFCLIB_MFDF_RESP_ADDITIONAL_FRAME) {
      statusTmp =  PH_ERR_SUCCESS_CHAINING;
    } else {
      statusTmp = PH_ERR_PROTOCOL_ERROR;
...
)
{
  ...
  *pResponse = pRecv;
  ...
  if ((bStatusByte != PH_NFCLIB_MFDF_RESP_OPERATION_OK) &&
      (bStatusByte != PH_NFCLIB_MFDF_ISO7816_SUCCESS)) {
    if (bStatusByte == PH_NFCLIB_MFDF_RESP_ADDITIONAL_FRAME) {
      statusTmp =  PH_ERR_SUCCESS_CHAINING;
    } else {
      statusTmp = PH_ERR_PROTOCOL_ERROR;
...
#if 0
    statusTmp = ((bStatusByte == PH_NFCLIB_MFDF_RESP_ADDITIONAL_FRAME) ? PH_ERR_SUCCESS_CHAINING :
            PH_ERR_PROTOCOL_ERROR);
#endif
  }
  return statusTmp;
...
)
{
  ...
  if ((statusTmp != PH_NFCLIB_MFDF_RESP_OPERATION_OK) &&
      (statusTmp != PH_NFCLIB_MFDF_ISO7816_SUCCESS_STATUS)) {
    return statusTmp;
  }
