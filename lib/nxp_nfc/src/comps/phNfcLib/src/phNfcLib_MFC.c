  ...
  switch (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_MifareClassic.bCommand) {
    ...
    case Authenticate:
      ...
      wStatus = phhalHw_MfcAuthenticate(
              ...
              &aKey[0],
              (gphNfcLib_State.pPeerInfo->uTi.uInitiator.tIso14443_3a.bUidLength == 4U) ?
              (&gphNfcLib_State.pPeerInfo->uTi.uInitiator.tIso14443_3a.aUid[0]) :
              (&gphNfcLib_State.pPeerInfo->uTi.uInitiator.tIso14443_3a.aUid[3])
          );
      break;
