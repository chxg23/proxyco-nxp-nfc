...
phNfcLib_ISO15693_Transmit(void *const pTxBuffer, uint16_t wTxBufferLength)
{
  ...
  gphNfcLib_Params.spalSli15693.bFlags  = gphNfcLib_Params.spalSli15693.bFlags & (uint8_t)~
      (uint8_t)PHPAL_SLI15693_FLAG_SELECTED;
  ...
  /* Clear option bit */
    ...
    gphNfcLib_Params.spalSli15693.bFlags  = gphNfcLib_Params.spalSli15693.bFlags & (uint8_t)~
        (uint8_t)PHPAL_SLI15693_FLAG_OPTION;
  }
   ...
   */
  if (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.bCommand >
  ...
  switch (((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.bCommand) {
    ...
    case ISO15693_ReadMultipleBlocks:
      ...
      if (((uint16_t)((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wBlockNumber + ((
                      phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wNumBlocks) >= 0x100U) {
        return PH_ERR_INVALID_PARAMETER;
      }
      ...
      if ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.bOption) != 0U) {
        if (gphNfcLib_State.wRxLength < ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wNumBlocks
                    + 1U) * 2U)) {
          return PH_ERR_PROTOCOL_ERROR;
        }
      } else {
    ...
    case ISO15693_Extended_ReadMultipleBlocks:
      ...
      /* Check number of blocks doesn't exceed 256 */
      if ((((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wBlockNumber + ((uint32_t)(((
                              phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wNumBlocks))) >= 0x10000U) {
        return PH_ERR_INVALID_PARAMETER;
      }
    ...
    case ISO15693_Extended_WriteMultipleBlocks:
      ...
      /* Check number of blocks doesn't exceed 256 */
      if (((uint16_t)((phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wBlockNumber + ((uint32_t)(((
                              phNfcLib_Transmit_t *)pTxBuffer)->phNfcLib_ISO15693.wNumBlocks))) >= 0x10000U) {
        return PH_ERR_INVALID_PARAMETER;
      }
