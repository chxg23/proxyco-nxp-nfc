...
typedef struct {
  uint16_t
  wId;               /**< ID of this component, do not modify. */
  ...
  pRtoxTimerCallback
  pRtoxCallback;      /**< Holds the function pointer of RTOX callback */
  ...
  pWtxTimerCallback
  pWtxCallback;       /**< Holds the function pointer of WTX callback */
...
typedef struct {
  phNfcLib_StateMachine_t
  bNfcLibState;                         /* State of the NfcLib takes value from enum phNfcLib_StateMachine_t */
