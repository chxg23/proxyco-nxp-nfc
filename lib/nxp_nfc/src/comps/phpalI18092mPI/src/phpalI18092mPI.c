...
)
{
  ...
  PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pNfcid3i_log, pNfcid3i,
...
#ifdef NXPBUILD__PHPAL_I18092MPI_SW
    case PHPAL_I18092MPI_SW_ID:
      status = phpalI18092mPI_Sw_Deselect((phpalI18092mPI_Sw_DataParams_t *)pDataParams,
              bDeselectCommand);
      break;
#endif /* NXPBUILD__PHPAL_I18092MPI_SW */
...
#ifdef NXPBUILD__PHPAL_I18092MPI_SW
    case PHPAL_I18092MPI_SW_ID:
      status = phpalI18092mPI_Sw_Exchange((phpalI18092mPI_Sw_DataParams_t *)pDataParams, wOption,
...
#ifdef NXPBUILD__PHPAL_I18092MPI_SW
    case PHPAL_I18092MPI_SW_ID:
      status = phpalI18092mPI_Sw_Transmit((phpalI18092mPI_Sw_DataParams_t *)pDataParams, wOption,
              pTxBuffer, wTxLength);
      break;
#endif /* NXPBUILD__PHPAL_I18092MPI_SW */
...
#ifdef NXPBUILD__PHPAL_I18092MPI_SW
    case PHPAL_I18092MPI_SW_ID:
      status = phpalI18092mPI_Sw_Receive((phpalI18092mPI_Sw_DataParams_t *)pDataParams, wOption,
...
#ifdef NXPBUILD__PHPAL_I18092MPI_SW
    case PHPAL_I18092MPI_SW_ID:
      status = phpalI18092mPI_Sw_SetConfig((phpalI18092mPI_Sw_DataParams_t *)pDataParams, wConfig,
              wValue);
      break;
#endif /* NXPBUILD__PHPAL_I18092MPI_SW */
...
#ifdef NXPBUILD__PHPAL_I18092MPI_SW
    case PHPAL_I18092MPI_SW_ID:
      status = phpalI18092mPI_Sw_GetConfig((phpalI18092mPI_Sw_DataParams_t *)pDataParams, wConfig,
              pValue);
      break;
#endif /* NXPBUILD__PHPAL_I18092MPI_SW */
...
#ifdef NXPBUILD__PH_LOG
  if ((status & PH_ERR_MASK) == PH_ERR_SUCCESS) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pNfcId3Out_log, pNfcId3Out,
        PHPAL_I18092MPI_NFCID3_LENGTH);
  }
#endif
  PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_INFO, status_log, &status);
