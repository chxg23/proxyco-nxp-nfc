...
/** Delta frame wait time (FWT) in microseconds = 49152/fc(3625), but an additional 50 micro seconds is required for NFC Forum Compliance execution. */
#define PHPAL_I14443P3B_SW_DELTA_FWT_US             3675U
