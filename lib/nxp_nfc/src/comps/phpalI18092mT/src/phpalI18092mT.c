...
)
{
  ...
  if ((status & PH_ERR_MASK) == PH_ERR_SUCCESS) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pTransportDataBytes_log, *pGeneralDataBytes,
        *wGeneralDataBytesLength);
  }
#endif
  PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
...
)
{
  ...
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pTransportDataBytes_log, pTransportDataBytes,
...
)
{
  ...
  if ((((status & PH_ERR_MASK) == PH_ERR_SUCCESS) ||
    ...
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, ppTransportDataBytes_log,
        *ppTransportDataBytes, *pTransportDataBytesLength);
  }
#endif
  PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_INFO, status_log, &status);
  PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_LEAVE);
...
#ifdef NXPBUILD__PHPAL_I18092MT_SW
    case PHPAL_I18092MT_SW_ID:
      status = phpalI18092mT_Sw_SetConfig((phpalI18092mT_Sw_DataParams_t *)pDataParams, wConfig,
              wValue);
      break;
#endif /* NXPBUILD__PHPAL_I18092MT_SW */
...
#ifdef NXPBUILD__PHPAL_I18092MT_SW
    case PHPAL_I18092MT_SW_ID:
      status = phpalI18092mT_Sw_GetConfig((phpalI18092mT_Sw_DataParams_t *)pDataParams, wConfig,
              pValue);
      break;
#endif /* NXPBUILD__PHPAL_I18092MT_SW */
