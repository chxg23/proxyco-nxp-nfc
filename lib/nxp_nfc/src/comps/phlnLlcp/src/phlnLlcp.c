...
)
{
  ...
  switch (PH_GET_COMPID(pDataParams)) {
    ...
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Activate((phlnLlcp_Sw_DataParams_t *)pDataParams, pRemoteGnrlBytes,
              bRemoteGnrBytesLen, bDevType);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_Init((phlnLlcp_Sw_DataParams_t *)pDataParams, psSocket,
              eSocketType, pSocketRxBuffer, dwSocketRxBufferSize);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_Register((phlnLlcp_Sw_DataParams_t *)pDataParams, pSocket,
              eSocketType, bLsap, pUri);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_WaitForConnection((phlnLlcp_Sw_DataParams_t *)pDataParams,
              pServerSocket, pConnServerSocket);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_Connect((phlnLlcp_Sw_DataParams_t *)pDataParams,
              pClientSocket, bDsap);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_ConnectViaUri((phlnLlcp_Sw_DataParams_t *)pDataParams,
              pClientSocket, pUri);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_Send((phlnLlcp_Sw_DataParams_t *)pDataParams, pClientSocket,
              pTxBuffer, dwTxBufferSize, wFrameOpt);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_DiscoverServices((phlnLlcp_Sw_DataParams_t *)pDataParams,
              pSocket, bListSize, bSNBuffSize, psServiceNameList, pSapList);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_SendTo((phlnLlcp_Sw_DataParams_t *)pDataParams,
              pClientSocket, bDsap, pTxBuffer, dwTxBufferSize, wFrameOpt);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_Disconnect((phlnLlcp_Sw_DataParams_t *)pDataParams,
              pClientSocket);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
...
#ifdef NXPBUILD__PHLN_LLCP_SW
    case PHLN_LLCP_SW_ID:
      status = phlnLlcp_Sw_Transport_Socket_Unregister((phlnLlcp_Sw_DataParams_t *)pDataParams,
              pSocket);
      break;
#endif /* NXPBUILD__PHLN_LLCP_SW */
