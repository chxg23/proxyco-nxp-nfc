...
phStatus_t
phpalI14443p4mC_Sw_Int_StartWtxTimer(
    phpalI14443p4mC_Sw_DataParams_t *pDataParams
)
{
  /* Start the micro seconds Timer in single shot mode. */
  os_cputime_delay_usecs((((pDataParams->bWtPercentage
...
phStatus_t
phpalI14443p4mC_Sw_Int_HandleRxChaining(
    phpalI14443p4mC_Sw_DataParams_t *pDataParams,
    uint16_t wOption,
    uint8_t **ppRxBuffer,
    uint16_t *pRxLength
...
phStatus_t
phpalI14443p4mC_Sw_Int_GetPduHeaderLength(
    phpalI14443p4mC_Sw_DataParams_t *pDataParams,
    uint8_t bNadInclude,
    uint8_t *pProtLength
)
...
phStatus_t
phpalI14443p4mC_Sw_Int_ValidateFrame(
    phpalI14443p4mC_Sw_DataParams_t *pDataParams,
    uint8_t *pRxBuffer,
    uint16_t wRxLength,
    uint8_t **ppPayload,
...
phStatus_t
phpalI14443p4mC_Sw_Int_IsValidIBlock(
    uint8_t bOpMode,
    uint8_t bCheckCid,
    uint8_t bCid,
    uint8_t bCheckNad,
...
phStatus_t
phpalI14443p4mC_Sw_Int_IsValidRBlock(
    uint8_t bOpMode,
    uint8_t bCheckCid,
    uint8_t bCid,
    uint8_t *pRxBuffer,
...
phStatus_t
phpalI14443p4mC_Sw_Int_IsValidSBlock(
    uint8_t bOpMode,
    uint8_t bCheckCid,
    uint8_t bCid,
    uint8_t bWtx,
...
)
{
  ...
  if (!((((pRxBuffer[PHPAL_I14443P4MC_SW_PCB_POS] & PHPAL_I14443P4MC_SW_PCB_WTX) !=
                  PHPAL_I14443P4MC_SW_PCB_DESELECT)
              || (pRxBuffer[PHPAL_I14443P4MC_SW_PCB_POS] & PHPAL_I14443P4MC_SW_PCB_WTX) !=
              PHPAL_I14443P4MC_SW_PCB_WTX))) {
    return (PH_ERR_PROTOCOL_ERROR | PH_COMP_PAL_I14443P4MC);
  }
