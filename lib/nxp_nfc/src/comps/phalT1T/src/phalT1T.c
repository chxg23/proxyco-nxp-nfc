...
#ifdef NXPBUILD__PHAL_T1T_SW
    case PHAL_T1T_SW_ID:
      status = phalT1T_Sw_ReadByte((phalT1T_Sw_DataParams_t *)pDataParams, pUid, bAddress,  pData,
              pLength);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
...
#ifdef NXPBUILD__PHAL_T1T_SW
    case PHAL_T1T_SW_ID:
      status = phalT1T_Sw_WriteEraseByte((phalT1T_Sw_DataParams_t *)pDataParams, pUid, bAddress,
              bTxData,  pRxData, pLength);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
...
#ifdef NXPBUILD__PHAL_T1T_SW
    case PHAL_T1T_SW_ID:
      status = phalT1T_Sw_WriteNoEraseByte((phalT1T_Sw_DataParams_t *)pDataParams, pUid, bAddress,
              bTxData,  pRxData, pLength);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
...
#ifdef NXPBUILD__PHAL_T1T_SW
    case PHAL_T1T_SW_ID:
      status = phalT1T_Sw_ReadSegment((phalT1T_Sw_DataParams_t *)pDataParams, pUid, bAddress,  pData,
              pLength);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
...
#ifdef NXPBUILD__PHAL_T1T_SW
    case PHAL_T1T_SW_ID:
      status = phalT1T_Sw_ReadBlock((phalT1T_Sw_DataParams_t *)pDataParams, pUid, bAddress,  pData,
              pLength);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
...
#ifdef NXPBUILD__PHAL_T1T_SW
    case PHAL_T1T_SW_ID:
      status = phalT1T_Sw_WriteEraseBlock((phalT1T_Sw_DataParams_t *)pDataParams, pUid, bAddress,
              pTxData,  pRxData, pLength);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
...
#ifdef NXPBUILD__PHAL_T1T_SW
    case PHAL_T1T_SW_ID:
      status = phalT1T_Sw_WriteNoEraseBlock((phalT1T_Sw_DataParams_t *)pDataParams, pUid, bAddress,
              pTxData,  pRxData, pLength);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
