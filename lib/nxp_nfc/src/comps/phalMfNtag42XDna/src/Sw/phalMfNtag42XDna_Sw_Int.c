    ...
    uint16_t wCmdLen, uint8_t **ppRxdata, uint16_t *pRxdataLen)
{
  ...
  if (bCmdBuff[0] != PHAL_MFNTAG42XDNA_RESP_ADDITIONAL_FRAME) {
    ...
    if ((pDataParams->bAuthMode == PHAL_MFNTAG42XDNA_AUTHENTICATEEV2) &&
      ...
      memcpy(&bWorkBuffer[wWorkBufferLen], pDataParams->bTi,
          PHAL_MFNTAG42XDNA_SIZE_TI); /* PRQA S 3200 */
  ...
  if ((pDataParams->bAuthMode == PHAL_MFNTAG42XDNA_AUTHENTICATEEV2) &&
    ...
    if (bCmdBuff[0] != PHAL_MFNTAG42XDNA_RESP_ADDITIONAL_FRAME) {
      ...
      /* TI */
      memcpy(&pDataParams->pUnprocByteBuff[pDataParams->bNoUnprocBytes], pDataParams->bTi,
          PHAL_MFNTAG42XDNA_SIZE_TI); /* PRQA S 3200 */
    ...
    if ((status & PH_ERR_MASK) == PH_ERR_SUCCESS) {
      ...
      memcpy(&pDataParams->pUnprocByteBuff[pDataParams->bNoUnprocBytes], pRecv,
          wTmp);  /* PRQA S 3200 */
...

{
  ...
  if (pDataParams->bAuthMode == PHAL_MFNTAG42XDNA_AUTHENTICATEEV2) {
    ...
    if ((bCommOption & PHAL_MFNTAG42XDNA_MAC_DATA_INCOMPLETE) !=
        PHAL_MFNTAG42XDNA_MAC_DATA_INCOMPLETE) {
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phCryptoSym_Encrypt(
              pDataParams->pCryptoDataParamsEnc,
              PH_CRYPTOSYM_CIPHER_MODE_CBC | (((wDataLen1 == 0) &&
                      (bCmdBuff[0] != PHAL_MFNTAG42XDNA_RESP_ADDITIONAL_FRAME)) ? PH_EXCHANGE_DEFAULT :
                  PH_EXCHANGE_BUFFER_LAST),
              bLastChunk,
              wLastChunkLen,
              bLastChunk
  ...
  */
  ...
  if (wTmp <= (wFrameLen - wCmdLen)) {
    wApduLen = ((wCmdLen == 0x01) &&
            (bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE)) ? 0 : PHAL_MFNTAG42XDNA_WRAP_HDR_LEN;
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phpalMifare_ExchangeL4(
            ...
            (((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE) &&
                    (bCommOption & PHAL_MFNTAG42XDNA_MAC_DATA_INCOMPLETE)) ? PH_EXCHANGE_TXCHAINING : 0),
            pApdu,
            wApduLen,
            &pRecv,
            &wRxlen));
    ...
    PH_CHECK_SUCCESS_FCT(statusTmp, phpalMifare_ExchangeL4(
            ...
            (((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE) &&
                    (bCommOption & PHAL_MFNTAG42XDNA_MAC_DATA_INCOMPLETE)) ? PH_EXCHANGE_TXCHAINING : 0),
            &pApdu[2],
            (uint16_t)((pDataParams->dwPayLoadLen > 0xFE) &&
                (bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE)) ? 0x02U : 0x01U,
            &pRecv,
            &wRxlen));
  ...
  if (pDataParams->bAuthMode == PHAL_MFNTAG42XDNA_AUTHENTICATEEV2) {
    ...
    */
    ...
    /*Required ?*/
    memcpy(&pDataParams->pUnprocByteBuff[pDataParams->bNoUnprocBytes], pResp,
        wRxlen); /* PRQA S 3200 */
    ...
    uint16_t wCmdLen, uint8_t bCommOption, uint8_t *pData, uint16_t wDataLen)
{
  ...
  if ((pDataParams->bAuthMode == PHAL_MFNTAG42XDNA_AUTHENTICATEEV2) &&
    ...
    if ((bCommOption & PHAL_MFNTAG42XDNA_MAC_DATA_INCOMPLETE) !=
      ...
      if (!(wDataLen)) {
        ...
        pDataParams->bNoUnprocBytes = (uint8_t)(wWorkBufferLen % PH_CRYPTOSYM_AES_BLOCK_SIZE);
        memcpy(pDataParams->pUnprocByteBuff, &bWorkBuffer[wWorkBufferLen - pDataParams->bNoUnprocBytes],
            pDataParams->bNoUnprocBytes); /* PRQA S 3200 */
      } else {
        wTmp = (PH_CRYPTOSYM_AES_BLOCK_SIZE - (wWorkBufferLen % PH_CRYPTOSYM_AES_BLOCK_SIZE));
        if (wDataLen < wTmp) {
          wTmp = wDataLen;
          pDataParams->bNoUnprocBytes = (uint8_t)(wTmp % PH_CRYPTOSYM_AES_BLOCK_SIZE);
          memcpy(pDataParams->pUnprocByteBuff, &pData[wTmp - pDataParams->bNoUnprocBytes],
              pDataParams->bNoUnprocBytes); /* PRQA S 3200 */
        }
        memcpy(&bWorkBuffer[wWorkBufferLen], pData,
            (wTmp - pDataParams->bNoUnprocBytes)); /* PRQA S 3200 */
        ...
        if (wTmp != wDataLen) {
          ...
          memcpy(pDataParams->pUnprocByteBuff, &pData[wDataLen - pDataParams->bNoUnprocBytes],
              pDataParams->bNoUnprocBytes); /* PRQA S 3200 */
        }
      }
    }
  ...
  if (wTotalLen == 0x0000) {
    ...
    if (wTmp <= (wFrameLen - wCmdLen)) {
      ...
      if (pDataParams->bWrappedMode) {
        ...
        PH_CHECK_SUCCESS_FCT(statusTmp, phpalMifare_ExchangeL4(
                pDataParams->pPalMifareDataParams,
                PH_EXCHANGE_BUFFER_LAST | (((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE) &&
                        (bCommOption & PHAL_MFNTAG42XDNA_MAC_DATA_INCOMPLETE)) ? PH_EXCHANGE_TXCHAINING : 0),
                &pApdu[2],
                (uint16_t)((pDataParams->dwPayLoadLen > 0xFE) &&
                    (bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE)) ? 0x02U : 0x01U,
  ...
  if ((status == PH_ERR_SUCCESS) &&
      ((bCommOption & PHAL_MFNTAG42XDNA_AUTHENTICATE_RESET) == PHAL_MFNTAG42XDNA_AUTHENTICATE_RESET)) {
    /* Reset authentication status */
    if (pDataParams->bAuthMode == PHAL_MFNTAG42XDNA_AUTHENTICATEEV2) {
      phalMfNtag42XDna_Sw_Int_ResetAuthStatus(pDataParams);
    }
      ...
      if ((bCommOption & 0xF0U) == PHAL_MFNTAG42XDNA_COMMUNICATION_MACD) {
        ...
        if ((statusTmp & PH_ERR_MASK) == PH_ERR_SUCCESS) {
          ...
          */
          ...
          /* TBD:Required */
          memcpy(&pDataParams->pUnprocByteBuff[pDataParams->bNoUnprocBytes], bWorkBuffer,
              wRxlen); /* PRQA S 3200 */
          pDataParams->bNoUnprocBytes += (uint8_t)wRxlen;
    ...
    uint8_t *pResp, uint16_t *pRespLen)
{
  ...
  do {
    ...
    wLeFieldLen = ((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE) &&
            (pDataParams->bWrappedMode == 1)) ? 1 : 0;
    ...
    if (pDataParams->bWrappedMode && (bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE) &&
    ...
    if (pDataParams->bWrappedMode) {
      ...
      if (bExtended7816 && (bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE)) {
        ...
        pApdu[4] = (uint8_t)(wTemLen + ((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE) ?
                    pDataParams->dwPayLoadLen  : (wCopyDataLen + wCopyLastChunkLen)));
      }

      wApduHeaderLen = ((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE) &&
              (wTemLen == 0)) ? 0 : wApduHeaderLen;

      PH_CHECK_SUCCESS_FCT(statusTmp, phpalMifare_ExchangeL4(
              pDataParams->pPalMifareDataParams,
              PH_EXCHANGE_BUFFER_FIRST | ((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE &&
                      bCommOptionTmp) ? PH_EXCHANGE_TXCHAINING : 0),
              pApdu,
              wApduHeaderLen,
              &pRecv,
              pRespLen));
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp,  phpalMifare_ExchangeL4(
              pDataParams->pPalMifareDataParams,
              PH_EXCHANGE_BUFFER_CONT | ((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE &&
                      bCommOptionTmp) ? PH_EXCHANGE_TXCHAINING : 0),
              &pCmd[wIndexCmdLen],
              wTemLen,
              &pRecv,
    ...
    if (bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE && bCommOptionTmp) {
      bStatusByte = (uint8_t)((pRecv[0] & 0xF0) == 0xA0) ? PHAL_MFNTAG42XDNA_RESP_ADDITIONAL_FRAME :
    ...
    if (pDataParams->bWrappedMode) {
      if (bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE_MAPPED) {
        ...
        if (wWrappedApduTrailerLenLeft > 0)
          wrappedApduTrailerLen = ((wFrameLen - wrappedApduHeaderLen - wCmdLen - wDataLen - wAddDataLen) /
        ...
        if (wAddDataLenLeft > 0)
          wAddDataLen = ((wFrameLen - wrappedApduHeaderLen - wrappedApduTrailerLen - wCmdLen - wDataLen) /
                  wAddDataLenLeft)
              ? wAddDataLenLeft
      ...
      if (bIsExtended7816 && (bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE_MAPPED)) {
        ...
        pApdu[4] = (uint8_t)(wCmdLen + ((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE_MAPPED) ?
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phpalMifare_ExchangeL4(
              pDataParams->pPalMifareDataParams,
              PH_EXCHANGE_BUFFER_FIRST | ((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE_MAPPED &&
                      wMoreDataToTransmit) ? PH_EXCHANGE_TXCHAINING : 0),
              &pApdu[wHeaderIdx],
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp,  phpalMifare_ExchangeL4(
              pDataParams->pPalMifareDataParams,
              PH_EXCHANGE_BUFFER_CONT | ((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE_MAPPED &&
                      wMoreDataToTransmit) ? PH_EXCHANGE_TXCHAINING : 0),
              &pCmd[1 + wCmdIdx],
              wCmdLen,
              &pRecv,
      ...
      PH_CHECK_SUCCESS_FCT(statusTmp, phpalMifare_ExchangeL4(
              pDataParams->pPalMifareDataParams,
              PH_EXCHANGE_BUFFER_LAST | ((bIns == PHAL_MFNTAG42XDNA_ISO_CHAINING_MODE_MAPPED &&
                      wMoreDataToTransmit) ? PH_EXCHANGE_TXCHAINING : 0),
              &pLe[wTrailerIdx],
    ...
    uint16_t wCmdLen, uint8_t **ppRxBuffer, uint32_t *pBytesRead)
{
  ...
  if (status == PH_ERR_SUCCESS) {
    ...
    if (pDataParams->bAuthMode == PHAL_MFNTAG42XDNA_NOT_AUTHENTICATED ||
        (pDataParams->bAuthMode == PHAL_MFNTAG42XDNA_AUTHENTICATE &&
            ((wOption & PH_EXCHANGE_CUSTOM_BITS_MASK) == PHAL_MFNTAG42XDNA_COMMUNICATION_PLAIN))) {
      *pBytesRead -= 2;
      return phalMfNtag42XDna_Int_ComputeErrorResponse(pDataParams, statusTmp);
    }
    ...
    uint8_t *pPcdCapsOut, uint8_t *pPdCapsOut)
{
  ...
  */
  ...
  if (bAuthOption == PHAL_MFNTAG42XDNA_AUTHFIRST_NON_LRP) {
    ...
    memcpy(pDataParams->bTi, &bCmdBuff[0],
        PHAL_MFNTAG42XDNA_SIZE_TI);  /* PRQA S 3200 */ /* Store the Transaction Identifier */
    memcpy(pPcdCapsOut, &bCmdBuff[26],
        6);                         /* PRQA S 3200 */ /* Update pPcdCapsOut */
    memcpy(pPdCapsOut, &bCmdBuff[20],
        6);                          /* PRQA S 3200 */ /* Update pPdCapsOut */
  } else {
