...
#include <nxp_nfc/phalMfNtag42XDna_Int.h>
#include <nxp_nfc/ph_RefDefs.h>

phStatus_t
phalMfNtag42XDna_Int_ComputeErrorResponse(void *pDataParams, uint16_t wStatus)
{
...
*/
phStatus_t
phalMfNtag42XDna_ExchangeCmd(void *pDataParams,  void *pPalMifareDataParams,
...
*/
phStatus_t
phalMfNtag42XDna_Int_Send7816Apdu(void *pDataParams, void *pPalMifareDataParams,
    uint8_t bOption, uint8_t bIns,
    uint8_t bP1, uint8_t bP2, uint32_t bLc, uint8_t bExtendedLenApdu, uint8_t *pDataIn, uint32_t bLe,
    uint8_t **ppDataOut,
    uint16_t *pDataLen)
{
  ...
  switch (bIns) {
    case PHAL_MFNTAG42XDNA_CMD_ISO7816_SELECT_FILE:
      ...
      statusTmp = phalMfNtag42XDna_Int_ISOSelectFile(pDataParams, pPalMifareDataParams, bOption,
              bCmdBuff, wCmdLen,
              (uint8_t)bLc, bExtendedLenApdu, pDataIn, (uint8_t)bLe, ppDataOut, pDataLen);
      break;

    case PHAL_MFNTAG42XDNA_CMD_ISO7816_UPDATE_BINARY:
      statusTmp = phalMfNtag42XDna_Int_ISOUpdateBinary(pDataParams, pPalMifareDataParams, bOption,
              bCmdBuff, wCmdLen,
...
phStatus_t
phalMfNtag42XDna_Int_ISOSelectFile(void *pDataParams, void *pPalMifareDataParams,
    uint8_t bOption, uint8_t *bCmdBuff,
    uint16_t wCmdLen, uint8_t bLc, uint8_t bExtendedLenApdu, uint8_t *pDataIn, uint8_t bLe,
    uint8_t  **ppDataOut, uint16_t *pDataLen)
{
  phStatus_t  PH_MEMLOC_REM statusTmp;
  ...
  PH_CHECK_SUCCESS_FCT(statusTmp, phalMfNtag42XDna_Int_ComputeErrorResponse(pDataParams,
          statusTmp));
  if (pDataLen != NULL) {
    *pDataLen = wRxlen - 2;
  }
...
phStatus_t
phalMfNtag42XDna_Int_ISOUpdateBinary(void *pDataParams, void *pPalMifareDataParams,
    uint8_t bOption, uint8_t *bCmdBuff,
    uint16_t wCmdLen, uint32_t dwLc, uint8_t bExtendedLenApdu, uint8_t *pDataIn, uint8_t **ppDataOut,
    uint16_t *pDataLen)
{
  phStatus_t  PH_MEMLOC_REM statusTmp;
  uint16_t    PH_MEMLOC_REM wRxlen;
