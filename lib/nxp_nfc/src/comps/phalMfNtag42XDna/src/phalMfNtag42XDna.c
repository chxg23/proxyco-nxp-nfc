...
#include <nxp_nfc/phalMfNtag42XDna.h>
...
phStatus_t
phalMfNtag42XDna_AuthenticateEv2(void *pDataParams, uint8_t bAuthOption,
    ...
    uint8_t *bPcdCapsOut, uint8_t *bPdCapsOut)
{
  ...
  if (bDivLen) {
    PH_ASSERT_NULL_PARAM(pDivInput, PH_COMP_AL_MFNTAG42XDNA);
  }
  if (bLenPcdCapsIn) {
    PH_ASSERT_NULL_PARAM(bPcdCapsIn, PH_COMP_AL_MFNTAG42XDNA);
  }
  ...
  switch (PH_GET_COMPID(pDataParams)) {
    ...
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_AuthenticateEv2((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              bAuthOption, wOption, wKeyNo, wKeyVer,
...
#ifdef NXPBUILD__PH_CRYPTOSYM
phStatus_t
phalMfNtag42XDna_SetConfiguration(void *pDataParams, uint8_t bOption, uint8_t *pData,
    uint8_t bDataLen)
{
  phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_SetConfiguration((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              bOption, pData, bDataLen);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_GetVersion(void *pDataParams, uint8_t *pVerInfo)
{
  phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_GetVersion((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              pVerInfo, &bVersionLength);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
#ifdef NXPBUILD__PH_CRYPTOSYM
phStatus_t
phalMfNtag42XDna_GetCardUID(void *pDataParams, uint8_t *pUid)
{
  phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_GetCardUID((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams, pUid,
              &bCardUidLength);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_ChangeKey(void *pDataParams, uint16_t wOption, uint16_t wOldKeyNo,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_ChangeKey((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams, wOption,
              wOldKeyNo, wOldKeyVer, wNewKeyNo,
...
phStatus_t
phalMfNtag42XDna_GetKeyVersion(void *pDataParams, uint8_t bKeyNo, uint8_t bKeySetNo,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_GetKeyVersion((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              bKeyNo, bKeySetNo, pKeyVersion, bRxLen);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_GetFileSettings(void *pDataParams, uint8_t bFileNo,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_GetFileSettings((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              bFileNo, pFSBuffer, bBufferLen);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
#ifdef NXPBUILD__PH_CRYPTOSYM
phStatus_t
phalMfNtag42XDna_GetFileCounters(void *pDataParams, uint8_t bOption, uint8_t bFileNo,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_GetFileCounters((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              bOption, bFileNo, pFileCounters, pRxLen);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_ChangeFileSettings(void *pDataParams, uint8_t bCommMode,
    ...
    uint8_t bAdditionalInfoLen, uint8_t *bAdditionalInfo)
{
  ...
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, bAdditionalInfo_log, bAdditionalInfo,
      bAdditionalInfoLen);
  PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
  ...
  if (bAdditionalInfoLen) {
    PH_ASSERT_NULL_PARAM(bAdditionalInfo, PH_COMP_AL_MFNTAG42XDNA);
  }
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_ChangeFileSettings((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              bCommMode, bFileNo, bFileOption, pAccessRights,
...
phStatus_t
phalMfNtag42XDna_ChangeFileSettingsSDM(void *pDataParams, uint8_t bOption,
    uint8_t bFileNo, uint8_t bFileOption, uint8_t *pAccessRights,
    uint8_t bSdmOptions, uint8_t *pSdmAccessRights, uint8_t *pVCUIDOffset, uint8_t *pSDMReadCtrOffset,
    uint8_t *pPICCDataOffset,
    uint8_t *pTTPermStatusOffset, uint8_t *pSDMMACInputOffset, uint8_t *pSDMENCOffset,
    ...
    uint8_t *pSDMReadCtrLimit)
{
  ...
  if (pTTPermStatusOffset != NULL) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pTTPermStatusOffset_log, pTTPermStatusOffset,
        3);
  }
  if (pSDMMACInputOffset != NULL) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pSDMMACInputOffset_log, pSDMMACInputOffset,
        3);
  }
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_ChangeFileSettingsSDM((phalMfNtag42XDna_Sw_DataParams_t *)
              pDataParams, bOption, bFileNo, bFileOption, pAccessRights,
              bSdmOptions, pSdmAccessRights, pVCUIDOffset, pSDMReadCtrOffset, pPICCDataOffset,
              pTTPermStatusOffset, pSDMMACInputOffset, pSDMENCOffset,
...
phStatus_t
phalMfNtag42XDna_ReadData(void *pDataParams, uint8_t bOption, uint8_t bIns,
    uint8_t bFileNo, uint8_t *pOffset, uint8_t *pLength,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_ReadData((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams, bOption,
              bIns, bFileNo, pOffset, pLength,
              ppRxdata, pRxdataLen);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_WriteData(void *pDataParams, uint8_t bOption, uint8_t bIns,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_WriteData((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams, bOption,
              bIns, bFileNo, pOffset,
              pTxData, pTxDataLen);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_IsoSelectFile(void *pDataParams, uint8_t bOption, uint8_t bSelector,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_IsoSelectFile((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              bOption, bSelector, pFid, pDFname, bDFnameLen,
...
phStatus_t
phalMfNtag42XDna_IsoReadBinary(void *pDataParams, uint16_t wOption, uint8_t bOffset,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_IsoReadBinary((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              wOption, bOffset, bSfid, dwBytesToRead,
...
phStatus_t
phalMfNtag42XDna_IsoUpdateBinary(void *pDataParams, uint8_t bOffset, uint8_t bSfid,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_IsoUpdateBinary((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              bOffset, bSfid, bExtendedLenApdu, pData,
              dwDataLen);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_ReadSign(void *pDataParams, uint8_t bAddr, uint8_t **pSignature)
{
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_ReadSign((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams, bAddr,
              pSignature);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_GetTagTamperStatus(void *pDataParams, uint8_t *pRxBuffer,
    uint8_t *pRxLen)
{
  phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_GetTagTamperStatus((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              pRxBuffer, pRxLen);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_GetConfig(void *pDataParams, uint16_t wConfig, uint16_t *pValue)
{
  phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_GetConfig((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams, wConfig,
              pValue);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_SetConfig(void *pDataParams, uint16_t wConfig, uint16_t wValue)
{
  phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_SetConfig((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams, wConfig,
              wValue);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
phStatus_t
phalMfNtag42XDna_ResetAuthentication(void *pDataParams)
{
  phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_ResetAuthentication((phalMfNtag42XDna_Sw_DataParams_t *)
              pDataParams);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
...
#ifdef NXPBUILD__PH_CRYPTOSYM
phStatus_t
phalMfNtag42XDna_CalculateMACSDM(void *pDataParams, uint8_t bSdmOption,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_CalculateMACSDM((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              bSdmOption, wSDMMacKeyNo, wSDMMacKeyVer, pUid,
...
phStatus_t
phalMfNtag42XDna_DecryptSDMENCFileData(void *pDataParams, uint8_t bSdmOption,
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_DecryptSDMENCFileData((phalMfNtag42XDna_Sw_DataParams_t *)
              pDataParams, bSdmOption, wEncKeyNo, wEncKeyVer, pUid,
...
phStatus_t
phalMfNtag42XDna_DecryptSDMPICCData(void *pDataParams, uint16_t wKeyNo,
    uint16_t wKeyVer, uint8_t *pEncdata, uint16_t wEncDataLen,
    uint8_t *pPlainData)
{
  phStatus_t PH_MEMLOC_REM status;
...
#ifdef NXPBUILD__PHAL_MFNTAG42XDNA_SW
    case PHAL_MFNTAG42XDNA_SW_ID:
      status = phalMfNtag42XDna_Sw_DecryptSDMPICCData((phalMfNtag42XDna_Sw_DataParams_t *) pDataParams,
              wKeyNo, wKeyVer, pEncdata, wEncDataLen,
              pPlainData);
      break;
#endif /* NXPBUILD__PHAL_MFNTAG42XDNA_SW */
