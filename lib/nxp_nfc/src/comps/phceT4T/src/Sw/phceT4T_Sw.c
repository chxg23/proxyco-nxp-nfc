...
)
{
  ...
  return phOsal_EventCreate(&pDataParams->T4TEventObj.EventHandle,
...
)
{
  ...
  phOsal_EventPost(&pDataParams->T4TEventObj.EventHandle, E_OS_EVENT_OPT_NONE, E_PH_OSAL_EVT_ERROR,
      NULL);
...
)
{
  ...
  do {
    /* Wait for RX Data */
    PH_CHECK_SUCCESS_FCT(status, phOsal_EventPend((volatile phOsal_Event_t *)(
                &pDataParams->T4TEventObj.EventHandle), E_OS_EVENT_OPT_PEND_SET_ANY, 0xFFFFFFFFU,
    ...
    if ((events & E_PH_OSAL_EVT_ERROR) == E_PH_OSAL_EVT_ERROR) {
      ...
      PH_CHECK_SUCCESS_FCT(status,
          phOsal_EventClear(&pDataParams->T4TEventObj.EventHandle, E_OS_EVENT_OPT_NONE, E_PH_OSAL_EVT_ERROR,
              NULL));
      ...
      /* Clear event */
      PH_CHECK_SUCCESS_FCT(status,
          phOsal_EventClear(&pDataParams->T4TEventObj.EventHandle, E_OS_EVENT_OPT_NONE,
              E_PH_OSAL_EVT_RXDATA_AVAILABLE, NULL));
      ...
      PH_CHECK_SUCCESS_FCT(status,
          phOsal_EventPost(&pDataParams->T4TEventObj.EventHandle, E_OS_EVENT_OPT_NONE,
              E_PH_OSAL_EVT_TXDATA_AVAILABLE, NULL));
    } else {
      /* Aborted */
