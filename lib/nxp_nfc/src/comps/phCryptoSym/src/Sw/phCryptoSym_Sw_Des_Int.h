...
void  phCryptoSym_Sw_Des_Permutate_IP(
    uint8_t PH_CRYTOSYM_SW_FAST_RAM
    *pStateIn,  /**< [In] State pointer containing the initial state. */
    uint8_t PH_CRYTOSYM_SW_FAST_RAM
    *pStateOut  /**< [Out] State pointer containing the permutated state. */
);
...
void  phCryptoSym_Sw_Des_Permutate_IP_Inv(
    uint8_t PH_CRYTOSYM_SW_FAST_RAM
    *pStateIn,  /**< [In] State pointer containing the computed state. */
    uint8_t PH_CRYTOSYM_SW_FAST_RAM
    *pStateOut  /**< [Out] State pointer containing the final state. */
);
...
void  phCryptoSym_Sw_Des_PC1_Permutation(
    ...
    uint8_t PH_CRYTOSYM_SW_FAST_RAM
    *pKeyOut   /**< [Out] key  pointer containing the permutated key. */
);
...
void phCryptoSym_Sw_Des_Expand(
    ...
    uint8_t PH_CRYTOSYM_SW_FAST_RAM
    *pRexp  /**< [Out] 8 bytes (containing 48 bits) of expanded data. */
);
