...
{
  pRexp[0] = (uint8_t)((uint8_t)(((pR[3] & 0x01U) << 5U) | (pR[0] >> 3U)) &
          MASK6); /* Input bits 32 1 2 3 4 5 */
  pRexp[1] = (uint8_t)((uint8_t)((pR[0] << 1U) | ((pR[1] & 0x80U) >> 7U)) &
          MASK6); /* Input bits 4 5 6 7 8 9 */
  pRexp[2] = (uint8_t)((uint8_t)(((pR[0] & 0x01U) << 5U) | (pR[1] >> 3U)) &
          MASK6); /* Input bits 8 9 10 11 12 13 */
  pRexp[3] = (uint8_t)((uint8_t)((pR[1] << 1U) | ((pR[2] & 0x80U) >> 7U)) &
          MASK6); /* Input bits 12 13 14 15 16 17 */
  pRexp[4] = (uint8_t)((uint8_t)(((pR[1] & 0x01U) << 5U) | (pR[2] >> 3U)) &
          MASK6); /* Input bits 16 17 18 19 20 21 */
  pRexp[5] = (uint8_t)((uint8_t)((pR[2] << 1U) | ((pR[3] & 0x80U) >> 7U)) &
          MASK6); /* Input bits 20 21 22 23 24 25*/
  pRexp[6] = (uint8_t)((uint8_t)(((pR[2] & 0x01U) << 5U) | (pR[3] >> 3U)) &
          MASK6); /* Input bits 24 25 26 27 28 29*/
  pRexp[7] = (uint8_t)((uint8_t)((pR[3] << 1U) | ((pR[0] & 0x80U) >> 7U)) &
