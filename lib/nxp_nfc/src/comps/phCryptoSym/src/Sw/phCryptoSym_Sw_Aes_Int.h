...
void phCryptoSym_Sw_Aes_SubBytesShiftRows(
    ...
    *pState     /**< [InOut] 16 byte array containing the state to operate on */
);
...
void phCryptoSym_Sw_Aes_AddRoundKey(
    uint8_t PH_CRYTOSYM_SW_FAST_RAM
    *pState,    /**< [InOut] 16 byte array containing the state to operate on */
    uint8_t PH_MEMLOC_BUF
    *pKey,            /**< [In] 240 byte array containing all round keys to be used. */
...
void phCryptoSym_Sw_Aes_AddRoundKey(
    ...
    *pState,    /**< [InOut] 16 byte array containing the state to operate on */
    uint8_t PH_CRYTOSYM_SW_FAST_RAM
    *pKey,      /**< [In] 32 byte array containing the current round key buffer. */
