...
)
{
  ...
  if ((0U != ((pDataParams->bCollPend & PHAC_DISCLOOP_POS_BIT_MASK_B))) &&
      ((pDataParams->baPasConDevLim[PHAC_DISCLOOP_TECH_TYPE_B] == 0x00U))) {
    pDataParams->sTypeBTargetInfo.bTotalTagsFound = 0;
        ...
        if (status == PH_ERR_SUCCESS) {
          ...
          if ((pDataParams->bNfcActivityVersion == PHAC_DISCLOOP_NFC_ACTIVITY_VERSION_1_1)
            ...
            status = phpalI14443p3b_SetSerialNo(
                    pDataParams->pPal1443p3bDataParams,
                    pDataParams->sTypeBTargetInfo.aTypeB_I3P3[pDataParams->sTypeBTargetInfo.bTotalTagsFound -
                                                                      (uint8_t)1U].aPupi
                );
          ...
          /* Symbol 12 */
          (void)memcpy(
              pDataParams->sTypeBTargetInfo.aTypeB_I3P3[pDataParams->sTypeBTargetInfo.bTotalTagsFound].aPupi,
