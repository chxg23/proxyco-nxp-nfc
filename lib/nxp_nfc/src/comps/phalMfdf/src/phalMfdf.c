...
)
{
  ...
  PH_ASSERT_NULL(pDataParams);
  if (0U != (bOption & 0x01U)) {
    PH_ASSERT_NULL(pISOFileId);
  }
  if (bISODFNameLen > 0U) {
    PH_ASSERT_NULL(pISODFName);
  }
  PH_ASSERT_NULL(pAid);
...
#ifdef NXPBUILD__PHAL_MFDF_SW
    case PHAL_MFDF_SW_ID:
      status = phalMfdf_Sw_GetApplicationIDs((phalMfdf_Sw_DataParams_t *)pDataParams, pAidBuff,
              pNumAIDs);
      break;
#endif /* NXPBUILD__PHAL_MFDF_SW */
...
#ifdef NXPBUILD__PHAL_MFDF_SW
    case PHAL_MFDF_SW_ID:
      status = phalMfdf_Sw_GetDFNames((phalMfdf_Sw_DataParams_t *)pDataParams, bOption, pDFBuffer,
              pDFInfoLen);
      break;
#endif /* NXPBUILD__PHAL_MFDF_SW */
...
#ifdef NXPBUILD__PHAL_MFDF_SW
    case PHAL_MFDF_SW_ID:
      status = phalMfdf_Sw_SetConfiguration((phalMfdf_Sw_DataParams_t *)pDataParams, bOption, pData,
              bDataSize);
      break;
#endif /* NXPBUILD__PHAL_MFDF_SW */
...
#ifdef NXPBUILD__PHAL_MFDF_SW
    case PHAL_MFDF_SW_ID:
      status = phalMfdf_Sw_GetFileSettings((phalMfdf_Sw_DataParams_t *)pDataParams, bFileNo, pFSBuffer,
              bBufferLen);
      break;
#endif /* NXPBUILD__PHAL_MFDF_SW */
...
#ifdef NXPBUILD__PHAL_MFDF_SW
    case PHAL_MFDF_SW_ID:
      status = phalMfdf_Sw_ChangeFileSettings((phalMfdf_Sw_DataParams_t *)pDataParams, bOption, bFileNo,
...
#endif /* NXPBUILD__PHAL_MFP_SAMAV2_NONX */
    case PHAL_MFDF_SAMAV3_NONX_ID:
      status = phalMfdf_Sam_NonX_ChangeFileSettings(pDataParams, bOption, bFileNo, bCommSett,
              pAccessRights);
      break;
#endif /* NXPBUILD__PHAL_MFDF_SAM_NONX */
...
#ifdef NXPBUILD__PHAL_MFDF_SW
    case PHAL_MFDF_SW_ID:
      status = phalMfdf_Sam_NonX_WriteRecord((phalMfdf_Sw_DataParams_t *)pDataParams, bCommOption,
              bFileNo, pOffset, pData, pDataLen);
      break;
#endif /* NXPBUILD__PHAL_MFDF_SW */
...
#ifdef NXPBUILD__PHAL_MFDF_SW
    case PHAL_MFDF_SW_ID:
      status = phalMfdf_Sw_IsoGetChallenge((phalMfdf_Sw_DataParams_t *)pDataParams, wKeyNo, wKeyVer,
              bLe, pRPICC1);
      break;
#endif /* NXPBUILD__PHAL_MFDF_SW */
...
#ifdef NXPBUILD__PH_NDA_MFDF
phStatus_t
phalMfdf_ResetAuthStatus(void *pDataParams)
{
  phStatus_t PH_MEMLOC_REM status;
