    ...
    uint8_t bKeyNoCard)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_ComputeErrorCode(pDataParams->pPalSli15693DataParams,
          wStatus));
    ...
    uint8_t bKeyNoCard, uint8_t bPurposeMAM2)
{
  ...
  (void)memcpy(aTChallenge_MAM1, &pResponse[wRespLen - 5u],
      (PHAL_ICODE_RANDOM_NUMBER_SIZE - 4U /* TChallenge */));
...
phalICode_Sw_ResetEAS(phalICode_Sw_DataParams_t *pDataParams, uint8_t bOption)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_ResetEAS(pDataParams->pPalSli15693DataParams,
          bOption));
...
phalICode_Sw_LockEAS(phalICode_Sw_DataParams_t *pDataParams, uint8_t bOption)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_LockEAS(pDataParams->pPalSli15693DataParams,
          bOption));
...
phalICode_Sw_WriteEASID(phalICode_Sw_DataParams_t *pDataParams, uint8_t *pEasIdValue)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_WriteEASID(pDataParams->pPalSli15693DataParams,
          pEasIdValue));
    ...
    uint16_t  *pEpcLen)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_ReadEPC(pDataParams->pPalSli15693DataParams, ppEpc,
          pEpcLen));
    ...
    uint16_t *pRndLen)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_GetRandomNumber(pDataParams->pPalSli15693DataParams,
          ppRnd, pRndLen));
    ...
    uint8_t bPwdIdentifier, uint8_t *pXorPwd)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_SetPassword(pDataParams->pPalSli15693DataParams,
    ...
    uint8_t bPwdIdentifier, uint8_t *pPwd)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_WritePassword(pDataParams->pPalSli15693DataParams,
          bPwdIdentifier, pPwd));
    ...
    uint8_t bPwdIdentifier)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_LockPassword(pDataParams->pPalSli15693DataParams,
          bPwdIdentifier));
    ...
    uint8_t bProtectionStatus)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_ProtectPage(pDataParams->pPalSli15693DataParams,
...
phalICode_Sw_Destroy(phalICode_Sw_DataParams_t *pDataParams, uint8_t *pXorPwd)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_Destroy(pDataParams->pPalSli15693DataParams,
          pXorPwd));
    ...
    uint16_t *pSignLen)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_ReadSignature(pDataParams->pPalSli15693DataParams,
          ppSign, pSignLen));
    ...
    uint8_t *pBitRate, uint8_t *pTiming)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_ParameterRequest(pDataParams->pPalSli15693DataParams,
          pBitRate, pTiming));
    ...
    uint8_t bTiming)
{
  ...
  PH_CHECK_SUCCESS_FCT(wStatus, phalICode_Int_ParameterSelect(pDataParams->pPalSli15693DataParams,
          bBitRate, bTiming));
