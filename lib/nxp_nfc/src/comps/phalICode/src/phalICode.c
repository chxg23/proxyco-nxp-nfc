 ...
 */
phStatus_t
phalICode_ReadSingleBlock(void *pDataParams, uint8_t bOption, uint8_t bBlockNo,
    uint8_t **ppData, uint16_t *pDataLen)
{
  ...
  switch (PH_GET_COMPID(pDataParams)) {
    ...
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ReadSingleBlock((phalICode_Sw_DataParams_t *) pDataParams, bOption,
              bBlockNo, ppData, pDataLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_WriteSingleBlock(void *pDataParams, uint8_t bOption, uint8_t bBlockNo,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_WriteSingleBlock((phalICode_Sw_DataParams_t *) pDataParams, bOption,
              bBlockNo, pData, bDataLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_LockBlock(void *pDataParams, uint8_t bOption, uint8_t bBlockNo)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_ReadMultipleBlocks(void *pDataParams, uint8_t bOption, uint8_t bBlockNo,
    uint8_t bNumBlocks,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ReadMultipleBlocks((phalICode_Sw_DataParams_t *) pDataParams, bOption,
 ...
 */
phStatus_t
phalICode_WriteAFI(void *pDataParams, uint8_t bOption, uint8_t bAfi)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_LockAFI(void *pDataParams, uint8_t bOption)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_WriteDSFID(void *pDataParams, uint8_t bOption, uint8_t bDsfid)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_LockDSFID(void *pDataParams, uint8_t bOption)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_GetSystemInformation(void *pDataParams, uint8_t **ppSystemInfo,
    uint16_t *pSystemInfoLen)
{
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_GetSystemInformation((phalICode_Sw_DataParams_t *) pDataParams,
  ...
  if ((wStatus & PH_ERR_MASK) == PH_ERR_SUCCESS) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(ppSystemInfo), *ppSystemInfo,
        *pSystemInfoLen);
  }
 ...
 */
phStatus_t
phalICode_GetMultipleBlockSecurityStatus(void *pDataParams, uint8_t bBlockNo,
    uint8_t bNoOfBlocks,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_GetMultipleBlockSecurityStatus((phalICode_Sw_DataParams_t *) pDataParams,
              bBlockNo, bNoOfBlocks, pStatus, pStatusLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_FastReadMultipleBlocks(void *pDataParams, uint8_t bOption, uint8_t bBlockNo,
    uint8_t bNumBlocks,
    uint8_t *pData, uint16_t *pDataLen)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_FastReadMultipleBlocks((phalICode_Sw_DataParams_t *) pDataParams, bOption,
              bBlockNo, bNumBlocks, pData, pDataLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_ExtendedReadSingleBlock(void *pDataParams, uint8_t bOption,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ExtendedReadSingleBlock((phalICode_Sw_DataParams_t *) pDataParams, bOption,
              wBlockNo, ppData, pDataLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_ExtendedWriteSingleBlock(void *pDataParams, uint8_t bOption,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ExtendedWriteSingleBlock((phalICode_Sw_DataParams_t *) pDataParams,
              bOption, wBlockNo, pData, bDataLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_ExtendedLockBlock(void *pDataParams, uint8_t bOption, uint16_t wBlockNo)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ExtendedLockBlock((phalICode_Sw_DataParams_t *) pDataParams, bOption,
              wBlockNo);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_ExtendedReadMultipleBlocks(void *pDataParams, uint8_t bOption,
    uint16_t wBlockNo, uint16_t wNumBlocks,
    uint8_t *pData, uint16_t *pDataLen)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ExtendedReadMultipleBlocks((phalICode_Sw_DataParams_t *) pDataParams,
 ...
 */
phStatus_t
phalICode_AuthenticateTAM1(void *pDataParams, uint8_t bOption, uint8_t bKeyNo,
    uint8_t bKeyVer, uint8_t bKeyNoCard,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_AuthenticateTAM1((phalICode_Sw_DataParams_t *) pDataParams, bOption,
              bKeyNo, bKeyVer, bKeyNoCard);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_AuthenticateTAM2(void *pDataParams, uint8_t bOption, uint8_t bKeyNo,
    uint8_t bKeyVer, uint8_t bKeyNoCard,
    uint8_t *pDivInput, uint8_t bDivLen, uint8_t bBlockSize, uint8_t bBlockCount, uint8_t bProfile,
    uint8_t bProtMode, uint16_t wOffset,
    uint8_t *pCustomData, uint16_t *pCustomDataLen)
{
  ...
  if ((wStatus & PH_ERR_MASK) == PH_ERR_SUCCESS) {
    ...
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(pCustomData), pCustomData,
        *pCustomDataLen);
  }
 ...
 */
phStatus_t
phalICode_AuthenticateMAM(void *pDataParams, uint8_t bOption, uint8_t bKeyNo,
    uint8_t bKeyVer, uint8_t bKeyNoCard,
 ...
 */
phStatus_t
phalICode_Challenge(void *pDataParams, uint8_t bKeyNoCard)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_ReadBuffer(void *pDataParams, uint8_t bVerify, uint8_t bKeyNo,
    uint8_t bKeyVer, uint8_t **ppResponse,
    uint16_t *pRespLen)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ReadBuffer((phalICode_Sw_DataParams_t *) pDataParams, bVerify, bKeyNo,
              bKeyVer, ppResponse, pRespLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
  ...
  if ((wStatus & PH_ERR_MASK) == PH_ERR_SUCCESS) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(ppResponse), *ppResponse,
        *pRespLen);
  }
 ...
 */
phStatus_t
phalICode_ExtendedGetSystemInformation(void *pDataParams, uint8_t bInfoParams,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ExtendedGetSystemInformation((phalICode_Sw_DataParams_t *) pDataParams,
              bInfoParams, ppSystemInfo, pSystemInfoLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_ExtendedGetMultipleBlockSecurityStatus(void *pDataParams, uint16_t wBlockNo,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ExtendedGetMultipleBlockSecurityStatus((phalICode_Sw_DataParams_t *)
              pDataParams, wBlockNo, wNoOfBlocks, pStatus, pStatusLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_ExtendedFastReadMultipleBlocks(void *pDataParams, uint8_t bOption,
    uint16_t wBlockNo, uint16_t wNumBlocks,
    uint8_t *pData, uint16_t *pDataLen)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ExtendedFastReadMultipleBlocks((phalICode_Sw_DataParams_t *) pDataParams,
              bOption, wBlockNo, wNumBlocks, pData, pDataLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_SetEAS(void *pDataParams, uint8_t bOption)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_ResetEAS(void *pDataParams, uint8_t bOption)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_LockEAS(void *pDataParams, uint8_t bOption)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_EASAlarm(void *pDataParams, uint8_t bOption, uint8_t *pEasIdValue,
    uint8_t bEasIdMaskLen, uint8_t **ppEas, uint16_t *pEasLen)
{
  ...
  PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
  PH_LOG_HELPER_ADDPARAM_UINT8(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(bOption), &bOption);
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(pEasIdValue), pEasIdValue,
      bEasIdMaskLen);
  PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_EASAlarm((phalICode_Sw_DataParams_t *) pDataParams, bOption, pEasIdValue,
 ...
 */
phStatus_t
phalICode_PasswordProtectEAS(void *pDataParams)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_PasswordProtectAFI(void *pDataParams)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_WriteEASID(void *pDataParams, uint8_t *pEasIdValue)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_ReadEPC(void *pDataParams, uint8_t **ppEpc, uint16_t *pEpcLen)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_GetNXPSystemInformation(void *pDataParams, uint8_t **ppSystemInfo,
    uint16_t  *pSystemInfoLen)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_GetNXPSystemInformation((phalICode_Sw_DataParams_t *) pDataParams,
              ppSystemInfo, pSystemInfoLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_GetRandomNumber(void *pDataParams, uint8_t **ppRnd, uint16_t *pRndLen)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_SetPassword(void *pDataParams, uint8_t bPwdIdentifier, uint8_t *pXorPwd)
{
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_SetPassword((phalICode_Sw_DataParams_t *) pDataParams, bPwdIdentifier,
              pXorPwd);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_WritePassword(void *pDataParams, uint8_t bPwdIdentifier, uint8_t *pPwd)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_WritePassword((phalICode_Sw_DataParams_t *) pDataParams, bPwdIdentifier,
              pPwd);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_LockPassword(void *pDataParams, uint8_t bPwdIdentifier)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_ProtectPage(void *pDataParams, uint8_t bPPAdd_PageNo,
    uint8_t bProtectionStatus)
{
  ...
  PH_LOG_HELPER_ADDPARAM_UINT8(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(bProtectionStatus),
      &bProtectionStatus);
  PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ProtectPage((phalICode_Sw_DataParams_t *) pDataParams, bPPAdd_PageNo,
              bProtectionStatus);
      break;
#endif /* NXPBUILD__PHAL_SLI_SW */
 ...
 */
phStatus_t
phalICode_LockPageProtectionCondition(void *pDataParams, uint8_t bPageNo)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_LockPageProtectionCondition((phalICode_Sw_DataParams_t *) pDataParams,
              bPageNo);
      break;
#endif /* NXPBUILD__PHAL_SLI_SW */
 ...
 */
phStatus_t
phalICode_GetMultipleBlockProtectionStatus(void *pDataParams, uint8_t bBlockNo,
    uint8_t bNoOfBlocks, uint8_t *pProtectionStates,
    uint16_t *pNumReceivedStates)
{
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_GetMultipleBlockProtectionStatus((phalICode_Sw_DataParams_t *) pDataParams,
              bBlockNo, bNoOfBlocks, pProtectionStates,
              pNumReceivedStates);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
  ...
  if ((wStatus & PH_ERR_MASK) == PH_ERR_SUCCESS) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, PH_LOG_VAR(ppProtectionStates),
 ...
 */
phStatus_t
phalICode_Destroy(void *pDataParams, uint8_t *pXorPwd)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_EnablePrivacy(void *pDataParams, uint8_t *pXorPwd)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_64BitPasswordProtection(void *pDataParams)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_ReadSignature(void *pDataParams, uint8_t **ppSign, uint16_t *pSignLen)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_ReadConfig(void *pDataParams, uint8_t bBlockAddr, uint8_t bNoOfBlocks,
    uint8_t **ppData, uint16_t *pDataLen)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ReadConfig((phalICode_Sw_DataParams_t *) pDataParams, bBlockAddr,
 ...
 */
phStatus_t
phalICode_WriteConfig(void *pDataParams, uint8_t bOption, uint8_t bBlockAddr,
    uint8_t  *pData)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_WriteConfig((phalICode_Sw_DataParams_t *) pDataParams, bOption, bBlockAddr,
              pData);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_PickRandomID(void *pDataParams)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_ParameterRequest(void *pDataParams, uint8_t *pBitRate, uint8_t *pTiming)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ParameterRequest((phalICode_Sw_DataParams_t *) pDataParams, pBitRate,
              pTiming);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_ParameterSelect(void *pDataParams, uint8_t bBitRate, uint8_t bTiming)
{
  phStatus_t  PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ParameterSelect((phalICode_Sw_DataParams_t *) pDataParams, bBitRate,
              bTiming);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_ReadSRAM(void *pDataParams, uint8_t bOption, uint8_t bBlockNo,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_ReadSRAM((phalICode_Sw_DataParams_t *) pDataParams, bOption, bBlockNo,
 ...
 */
phStatus_t
phalICode_WriteSRAM(void *pDataParams, uint8_t bOption, uint8_t bBlockNo,
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_WriteSRAM((phalICode_Sw_DataParams_t *) pDataParams, bOption, bBlockNo,
              bNumBlocks, pData, wDataLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_I2CMRead(void *pDataParams, uint8_t bAddr_Config, uint8_t bDataLen,
    uint8_t  *pData)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_I2CMRead((phalICode_Sw_DataParams_t *) pDataParams, bAddr_Config, bDataLen,
              pData);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_I2CMWrite(void *pDataParams, uint8_t bAddr_Config, uint8_t *pData,
    uint8_t bDataLen)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
...
#ifdef NXPBUILD__PHAL_ICODE_SW
    case PHAL_ICODE_SW_ID:
      wStatus = phalICode_Sw_I2CMWrite((phalICode_Sw_DataParams_t *) pDataParams, bAddr_Config, pData,
              bDataLen);
      break;
#endif /* NXPBUILD__PHAL_ICODE_SW */
 ...
 */
phStatus_t
phalICode_GetConfig(void *pDataParams, uint16_t wConfig, uint16_t *pValue)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_SetConfig(void *pDataParams, uint16_t wConfig, uint16_t wValue)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
 ...
 */
phStatus_t
phalICode_GetTagType(void *pDataParams, uint16_t *pTagType)
{
  phStatus_t PH_MEMLOC_REM wStatus = 0;
