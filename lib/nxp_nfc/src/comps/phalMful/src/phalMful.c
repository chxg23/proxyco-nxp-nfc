    ...
    uint8_t bDivInputLen)
{
  ...
  if (bDivInputLen) {
    PH_ASSERT_NULL_PARAM(pDivInput, PH_COMP_AL_MFUL);
  }
...
#ifdef NXPBUILD__PHAL_MFUL_SW
    case PHAL_MFUL_SW_ID:
      status = phalMful_Sw_AuthenticateAES((phalMful_Sw_DataParams_t *) pDataParams, wKeyNo, wKeyVer,
              bKeyNoCard);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
...
)
{
  ...
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pData_log, pData,
...
)
{
  ...
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pCnt_log, pCnt,
...
)
{
  ...
  PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pCntValue_log, pCntValue,
...
)
{
  ...
  PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pVersion_log, pVersion,
...
#ifdef NXPBUILD__PHAL_MFUL_SW
    case PHAL_MFUL_SW_ID:
      status = phalMful_Sw_ChkTearingEvent((phalMful_Sw_DataParams_t *)pDataParams, bCntNum,
              pValidFlag);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
...
)
{
  ...
  PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
  PH_LOG_HELPER_ADDPARAM_UINT8(PH_LOG_LOGTYPE_DEBUG, bAddress_log, &bAddress);
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pSignature_log, pSignature,
      PHAL_MFUL_WRITE_BLOCK_LENGTH);
  PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
  PH_ASSERT_NULL(pDataParams);
  PH_ASSERT_NULL(pSignature);
...
#ifdef NXPBUILD__PHAL_MFUL_SW
    case PHAL_MFUL_SW_ID:
      status = phalMful_Sw_VirtualCardSelect((phalMful_Sw_DataParams_t *)pDataParams, pVCIID, bVCIIDLen,
              pVCTID);
      break;
#endif /* NXPBUILD__PHAL_MFUL_SW */
...
#ifdef NXPBUILD__PHAL_MFUL_SW
    case PHAL_MFUL_SW_ID:
      status = phalMful_Sw_CalculateSunCMAC((phalMful_Sw_DataParams_t *)pDataParams, wKeyNo,  wKeyVer,
