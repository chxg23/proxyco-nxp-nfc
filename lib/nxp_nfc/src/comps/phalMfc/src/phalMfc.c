...
#ifdef NXPBUILD__PHAL_MFC_SW
    case PHAL_MFC_SW_ID:
      status = phalMfc_Sw_Authenticate((phalMfc_Sw_DataParams_t *)pDataParams, bBlockNo, bKeyType,
              wKeyNumber, wKeyVersion, pUid, bUidLength);
      break;
#endif /* NXPBUILD__PHAL_MFC_SW */
...
#ifdef NXPBUILD__PHAL_MFC_SW
    case PHAL_MFC_SW_ID:
      status = phalMfc_Sw_ReadValue((phalMfc_Sw_DataParams_t *)pDataParams, bBlockNo, pValue,
              pAddrData);
      break;
#endif /* NXPBUILD__PHAL_MFC_SW */
...
#ifdef NXPBUILD__PHAL_MFC_SW
    case PHAL_MFC_SW_ID:
      status = phalMfc_Sw_WriteValue((phalMfc_Sw_DataParams_t *)pDataParams, bBlockNo, pValue,
              bAddrData);
      break;
#endif /* NXPBUILD__PHAL_MFC_SW */
...
#ifdef NXPBUILD__PHAL_MFC_SW
    case PHAL_MFC_SW_ID:
      status = phalMfc_Sw_IncrementTransfer((phalMfc_Sw_DataParams_t *)pDataParams, bSrcBlockNo,
              bDstBlockNo, pValue);
      break;
#endif /* NXPBUILD__PHAL_MFC_SW */
...
#ifdef NXPBUILD__PHAL_MFC_SW
    case PHAL_MFC_SW_ID:
      status = phalMfc_Sw_DecrementTransfer((phalMfc_Sw_DataParams_t *)pDataParams, bSrcBlockNo,
              bDstBlockNo, pValue);
      break;
#endif /* NXPBUILD__PHAL_MFC_SW */
...
#ifdef NXPBUILD__PHAL_MFC_SW
    case PHAL_MFC_SW_ID:
      status = phalMfc_Sw_RestoreTransfer((phalMfc_Sw_DataParams_t *)pDataParams, bSrcBlockNo,
              bDstBlockNo);
      break;
#endif /* NXPBUILD__PHAL_MFC_SW */
