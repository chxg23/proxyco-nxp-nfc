...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_SelectVc((phalVca_Sw_DataParams_t *) pDataParams, wValidIidIndex, wKeyNumber,
              wKeyVersion);
      break;
#endif /* NXPBUILD__PHAL_VCA_SW */
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_VcSupport((phalVca_Sw_DataParams_t *) pDataParams, pIid, wKeyEncNumber,
              wKeyEncVersion, wKeyMacNumber, wKeyMacVersion);
      break;
#endif /* NXPBUILD__PHAL_VCA_SW */
    ...
    uint16_t wKeyEncVersion, uint16_t wKeyMacNumber, uint16_t wKeyMacVersion)
{
  ...
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pPcdCapabilities_log, pPcdCapabilities,
      bLenCap);
  PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, wKeyEncNumber_log, &wKeyEncNumber);
  PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, wKeyEncVersion_log, &wKeyEncVersion);
  PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, wKeyMacNumber_log, &wKeyMacNumber);
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_VcSupportLast((phalVca_Sw_DataParams_t *) pDataParams, pIid, bLenCap,
              pPcdCapabilities,
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_GetIidInfo((phalVca_Sw_DataParams_t *) pDataParams, wValidIidIndex, pIidIndex,
              pVcUidSize,
    ...
    uint8_t *pResponse, uint16_t *pRespLen)
{
  ...
  if (pDivInput != NULL) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pDivInput_log, pDivInput,
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_IsoSelect((phalVca_Sw_DataParams_t *) pDataParams, bSelectionControl, bOption,
              bDFnameLen,
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_IsoExternalAuthenticate((phalVca_Sw_DataParams_t *) pDataParams, pInData,
              wKeyNumber, wKeyVersion);
      break;
#endif /* NXPBUILD__PHAL_VCA_SW */
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_ProximityCheck((phalVca_Sw_DataParams_t *) pDataParams, bGenerateRndC, pRndC,
              bPps1, bNumSteps, wKeyNumber,
    ...
    uint8_t *pResponse, uint16_t *pRespLen, uint8_t *pCumRndRC)
{
  ...
  switch (PH_GET_COMPID(pDataParams)) {
    ...
    case PHAL_VCA_SW_ID:
      ...
      status = phalVca_Sw_ProximityCheckNew((phalVca_Sw_DataParams_t *) pDataParams, bOption, pPrndC,
              bNumSteps, wKeyNumber, wKeyVersion,
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_Cmd_PrepareProximityCheckNew((phalVca_Sw_DataParams_t *)pDataParams, bOption,
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_Cmd_ProximityCheckNew((phalVca_Sw_DataParams_t *) pDataParams, bGenerateRndC,
              pPrndC, bNumSteps,
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_Cmd_VerifyProximityCheckNew((phalVca_Sw_DataParams_t *)pDataParams, bOption,
              pPubRespTime, pResponse, wRespLen,
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_Cmd_VerifyProximityCheckUtility((phalVca_Sw_DataParams_t *) pDataParams,
              pCmdMac, pCmdResp);
      break;
#endif /* NXPBUILD__PHAL_VCA_SW */
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_SetSessionKeyUtility((phalVca_Sw_DataParams_t *) pDataParams, pSessionKey,
              bAuthMode);
      break;
#endif /* NXPBUILD__PHAL_VCA_SW */
...
#ifdef NXPBUILD__PHAL_VCA_SW
    case PHAL_VCA_SW_ID:
      status = phalVca_Sw_DecryptResponse((phalVca_Sw_DataParams_t *) pDataParams, wKeyNo, wKeyVersion,
              pInData, pRandChal, pVCData);
      break;
#endif /* NXPBUILD__PHAL_VCA_SW */
