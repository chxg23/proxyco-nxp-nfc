...
static const pphalTop_Sw_Int_SetReadOnly
pfphalTop_Sw_Int_SetReadOnly[PHAL_TOP_MAX_TAGTYPE_SUPPORTED] = {
#if defined(NXPBUILD__PHAL_T1T_SW)
...
)
{
  switch (wConfig) {
    ...
    case PHAL_TOP_CONFIG_T4T_NDEF_FILE_ID:
      ...
      ((phalTop_T4T_t *)(&pDataParams->ualTop.salTop_T4T))->aNdefFileID[0] = (uint8_t)(
              wValue & 0x00FFU);
      ((phalTop_T4T_t *)(&pDataParams->ualTop.salTop_T4T))->aNdefFileID[1] = (uint8_t)((
                  wValue & 0xFF00U) >> 8U);
      break;
