...
static phStatus_t phalMfcTop_Sw_Write(phalTop_Sw_DataParams_t *pDataParams, uint8_t *pData,
    uint8_t bBlockNumber);
static phStatus_t phalMfcTop_Sw_ReadNfcSector(phalTop_Sw_DataParams_t *pDataParams,
  ...
  for (bCount = 0; bCount < 5U; bCount++) {
    ...
    if ((bCount == 0U) || (bCount == 2U)) {
      status =  phhalHw_MfcAuthenticate(
              ...
              & ((phpalI14443p3a_Sw_DataParams_t *)(pMfcTop->pPalI14443paDataParams))->abUid[0] : & ((
                      phpalI14443p3a_Sw_DataParams_t *)(pMfcTop->pPalI14443paDataParams))->abUid[3]
          );
...
)
{
  ...
  if ((pDataParams->bTagState != PHAL_MFCTOP_STATE_READWRITE) &&
      (pDataParams->bTagState != PHAL_MFCTOP_STATE_READONLY)) {
  ...
  aCommand[1] = (pMfcTop->bFirstNdefSector > 0x1FU) ?
      (((pMfcTop->bFirstNdefSector + 1U) * 4U) + (((pMfcTop->bFirstNdefSector + 1U) * 16U) - (16U -
                  (pMfcTop->bNdefMessageStart / PHAL_MFCTOP_BLOCK_SIZE)))) :
      (((pMfcTop->bFirstNdefSector + 1U) * 4U) - (4U - (pMfcTop->bNdefMessageStart /
  ...
  if (status == PH_ERR_SUCCESS) {
    ...
    bFirstReadLength = (uint8_t)((PHAL_MFCTOP_BLOCK_SIZE - ((pMfcTop->bNdefMessageStart %
                        PHAL_MFCTOP_BLOCK_SIZE) + ((pDataParams->wNdefLength < 0xFFU) ? 2U : 4U))));

    /* assigning the data and length to the pointer provided by the application */
    (void)memcpy(pData, (pRxBuffer + (pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) + ((
                    pDataParams->wNdefLength < 0xFFU) ? 2U : 4U)), bFirstReadLength);
  ...
  while (0U != bReadOperations) {
    ...
    if (((aCommand[1] > 0x7FU) ? ((aCommand[1] - 0x80U) % PHAL_MFCTOP_MAD2_SECTOR_SIZE) :
            (aCommand[1] % PHAL_MFCTOP_SECTOR_SIZE)) == 0x00U) {
    ...
    if (!((aCommand[1] > 0x7FU) ? (((aCommand[1] - 0x80U) % PHAL_MFCTOP_MAD2_SECTOR_SIZE) == 0x0FU)
            : ((aCommand[1] % PHAL_MFCTOP_SECTOR_SIZE) == 0x03U))) {
      /* Read the Block */
      PH_CHECK_SUCCESS_FCT(status, phhalHw_Exchange(
              ((phpalI14443p3a_Sw_DataParams_t *)(pMfcTop->pPalI14443paDataParams))->pHalDataParams,
              PH_EXCHANGE_DEFAULT,
...
)
{
  ...
  if ((pDataParams->bTagState != PHAL_MFCTOP_STATE_INITIALIZED) &&
  ...
  if (pMfcTop->bFirstNdefSector > 0x1FU) {
    bBlockNumber = (uint8_t)(0x80U + (((pMfcTop->bFirstNdefSector - 0x20U) + 1U) * 16U) - (16U -
                (pMfcTop->bNdefMessageStart / PHAL_MFCTOP_BLOCK_SIZE)));
  } else {
    bBlockNumber = (uint8_t)((pMfcTop->bFirstNdefSector + 1U) * 4U) - (4U -
            (pMfcTop->bNdefMessageStart / PHAL_MFCTOP_BLOCK_SIZE));
  }

  if ((pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) >= (PHAL_MFCTOP_BLOCK_SIZE -
          bLengthByte)) {
    bSpillOver = 1;
  }
  ...
  if (0U == (bSpillOver)) {
    if (0u != ((pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE))) {
      ...
      phMemCopy(&aWriteLength[0], pRxBuffer,
          (((uint16_t)(pMfcTop->bNdefMessageStart)) % PHAL_MFCTOP_BLOCK_SIZE));
    }
    ...
    if (bLengthByte == 1U) {
      ...
      if ((pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) < (PHAL_MFCTOP_BLOCK_SIZE -
              bLengthByte)) {
        (void)memset(&aWriteLength[(pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) + 1U], 0x00,
            bLengthByte);
      }
    }
    ...
    bBlockNumber++;
    pMfcTop->bOffset = (pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) -
        (PHAL_MFCTOP_BLOCK_SIZE - bLengthByte);
    aCommand[0] = 0x00;
  }
  ...
  if (wLength > (PHAL_MFCTOP_BLOCK_SIZE - ((uint16_t)(pMfcTop->bOffset)))) {
    ...
    bCount = (uint8_t)((wLength - (PHAL_MFCTOP_BLOCK_SIZE - ((uint16_t)(pMfcTop->bOffset)))) /
            PHAL_MFCTOP_BLOCK_SIZE);
    bTerminatorByte = (uint8_t)((wLength - (PHAL_MFCTOP_BLOCK_SIZE - ((uint16_t)(
                            pMfcTop->bOffset)))) % PHAL_MFCTOP_BLOCK_SIZE);
  ...
  if (pMfcTop->bOffset < PHAL_MFCTOP_BLOCK_SIZE) {
    ...
    phMemCopy(&aWriteLength[pMfcTop->bOffset], pData,
        (PHAL_MFCTOP_BLOCK_SIZE - ((uint16_t)(pMfcTop->bOffset))));
  }
  ...
  while (0U != bCount) {
    ...
    if (((bBlockNumber > 0x7FU) ? ((bBlockNumber - 0x80U) % PHAL_MFCTOP_MAD2_SECTOR_SIZE) :
            (bBlockNumber % PHAL_MFCTOP_SECTOR_SIZE)) == 0U) {
    ...
    if (!((bBlockNumber > 0x7FU) ? (((bBlockNumber - 0x80U) % PHAL_MFCTOP_MAD2_SECTOR_SIZE) == 0x0FU)
            : ((bBlockNumber % PHAL_MFCTOP_SECTOR_SIZE) == 0x03U))) {
      PH_CHECK_SUCCESS_FCT(status, phalMfcTop_Sw_Write(pDataParams, aCommand, bBlockNumber));
      wDataOffset = ((PHAL_MFCTOP_BLOCK_SIZE - ((pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) +
                      1U + bLengthByte)) + (PHAL_MFCTOP_BLOCK_SIZE * bLoopCount));
      bLoopCount++;
      bCount--;
    }
  ...
  if (bLengthByte == 1U) {
    ...
    if (0U == (bSpillOver)) {
      ...
      aWriteLength[(pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) + 2U] = (uint8_t)((
                  wLength & 0xFF00U) >> 8U);
      aWriteLength[(pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) + 3U] = (uint8_t)(
              wLength & 0x00FFU);
    } else {
      aWriteLength[0] = 0xFF;
...
)
{
  ...
  if (0U != (pMfcTop->bPreFormatted)) {
    if ((pMfcTop->bCardType == PHAL_MFCTOP_MFC_4K) || (pMfcTop->bCardType == PHAL_MFCTOP_MFP_4K) ||
        (pMfcTop->bCardType == PHAL_MFCTOP_MFP_2K)) {
    ...
    if ((*(pRxBuffer + 6U) == 0xFFU) && (*(pRxBuffer + 7U) == 0x07U) &&
        (*(pRxBuffer + 8U) == 0x80U)) {
      bAuthKey = PHHAL_HW_MFC_KEYA;
    } else if ((*(pRxBuffer + 6U) == 0x7FU) && (*(pRxBuffer + 7U) == 0x07U) &&
        (*(pRxBuffer + 8U) == 0x88U)) {
  ...
  do {
    ...
    if (bSectorCount != 0x10U) {
      ...
      if (0U != (bFirstSector)) {
        ...
        /* Writing the first block  of MAD sector */
        PH_CHECK_SUCCESS_FCT(status, phalMfcTop_Sw_Write(pDataParams, &aNFCSectorBlock0[0],
                bBlockNo - 3u));
  ...
  pDataParams->bVno = (uint8_t)((aNFCSectorTrailer[PHAL_MFCTOP_GPB_BYTE] &
              PHAL_MFCTOP_GPB_MAJORVERSION) >> 6U);
  pDataParams->bVno |= (aNFCSectorTrailer[PHAL_MFCTOP_GPB_BYTE] & PHAL_MFCTOP_GPB_MINORVERSION) >>
      4U;
    ...
    uint8_t *pTxBuffer, uint16_t wTxLength)
{
  ...
  /* Disable RxCrc */
  (void) phhalHw_SetConfig(((phpalI14443p3a_Sw_DataParams_t *)(
              pMfcTop->pPalI14443paDataParams))->pHalDataParams, PHHAL_HW_CONFIG_RXCRC, PH_OFF);
  ...
  if ((status & PH_ERR_MASK) == PH_ERR_SUCCESS_INCOMPLETE_BYTE) {
    /* Retrieve bitcount */
    PH_CHECK_SUCCESS_FCT(status, phhalHw_GetConfig(((phpalI14443p3a_Sw_DataParams_t *)(
                    pMfcTop->pPalI14443paDataParams))->pHalDataParams, PHHAL_HW_CONFIG_RXLASTBITS, &wValidBits));
...
)
{
  ...
  while (0u != (lwNFCSectorCount & (lwTemp << (pMfcTop->bFirstNdefSector)))) {
    do {
      ...
      if (((*(pRxBuffer + PHAL_MFCTOP_GPB_BYTE) & PHAL_MFCTOP_GPB_MAJORVERSION) >> 6U) >
          PHAL_MFCTOP_MAJORVERSION) {
        return PH_ADD_COMPCODE_FIXED(PHAL_TOP_ERR_UNSUPPORTED_VERSION, PH_COMP_AL_TOP);
      } else {
        pDataParams->bVno = (uint8_t)((*(pRxBuffer + PHAL_MFCTOP_GPB_BYTE) & PHAL_MFCTOP_GPB_MAJORVERSION)
                >> 6U);
        pDataParams->bVno |= ((*(pRxBuffer + PHAL_MFCTOP_GPB_BYTE) & PHAL_MFCTOP_GPB_MINORVERSION) >> 4U);

        /* Validating Read and write access */
        if ((((*(pRxBuffer + PHAL_MFCTOP_GPB_BYTE) & PHAL_MFCTOP_GPB_READACCESS) >> 2U) !=
                PHAL_MFCTOP_ACCESS_GRANTED) ||
            (((*(pRxBuffer + PHAL_MFCTOP_GPB_BYTE) & PHAL_MFCTOP_GPB_WRITEACCESS) !=
                    PHAL_MFCTOP_ACCESS_GRANTED) &&
                (((*(pRxBuffer + PHAL_MFCTOP_GPB_BYTE) & PHAL_MFCTOP_GPB_WRITEACCESS) !=
                        PHAL_MFCTOP_ACCESS_DENIED)))) {
          break;
        }
          ...
          if (bBreakLoop != 1U) {
            for (bDetectNdefTLV = 0; bDetectNdefTLV < 16U; bDetectNdefTLV++) {
              ...
              if (*(pRxBuffer + bDetectNdefTLV) == PHAL_MFCTOP_NDEF_TLV) {
                bCheckForLength = 1;
                if (pMfcTop->bFirstNdefSector >  0x1FU) {
                  pMfcTop->bNdefMessageStart = ((PHAL_MFCTOP_MAD2_SECTOR_DATA_SIZE - bBlockCount) *
                          PHAL_MFCTOP_BLOCK_SIZE) + bDetectNdefTLV;
                } else {
                  pMfcTop->bNdefMessageStart = ((PHAL_MFCTOP_SECTOR_DATA_SIZE - bBlockCount) *
                          PHAL_MFCTOP_BLOCK_SIZE) + bDetectNdefTLV;
                }
              ...
              if (*(pRxBuffer + bDetectNdefTLV + 1U) == 0x00U) {
                ...
                *pTagState = PHAL_MFCTOP_STATE_INITIALIZED;
                ...
                if (*(pRxBuffer + (pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) + 1U) == 0xFFU) {
                  /* Length field is 3 bytes */
                  pDataParams->wNdefLength = ((uint16_t)(*(pRxBuffer + (pMfcTop->bNdefMessageStart %
                                      PHAL_MFCTOP_BLOCK_SIZE) + 2U)) << 8U);
                  pDataParams->wNdefLength |= *(pRxBuffer + (pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) +
                          3U);
                } else {
                  /*Length Field is 1 byte */
                  pDataParams->wNdefLength = *(pRxBuffer + (pMfcTop->bNdefMessageStart % PHAL_MFCTOP_BLOCK_SIZE) +
    ...
    if (0u != (*pTagState)) {
      ...
      pDataParams->wMaxNdefLength = (uint16_t)((PHAL_MFCTOP_SECTOR_DATA_SIZE * PHAL_MFCTOP_BLOCK_SIZE)
              - ((uint16_t)(pMfcTop->bNdefMessageStart)));
      if ((pMfcTop->bFirstNdefSector + pMfcTop->bNdefSectorCount) > 31U) {
        pDataParams->wMaxNdefLength += (uint16_t)(((((uint16_t)(pMfcTop->bFirstNdefSector)) > 16u) ?
                    (31U - ((uint16_t)(pMfcTop->bFirstNdefSector))) : (30U - ((uint16_t)(
                                pMfcTop->bFirstNdefSector)))) *
                PHAL_MFCTOP_SECTOR_DATA_SIZE * PHAL_MFCTOP_BLOCK_SIZE);
        pDataParams->wMaxNdefLength += (uint16_t)((((((uint16_t)(pMfcTop->bNdefSectorCount)) + ((
                                    uint16_t)(pMfcTop->bFirstNdefSector)))) - 31U) *
                PHAL_MFCTOP_MAD2_SECTOR_DATA_SIZE * PHAL_MFCTOP_BLOCK_SIZE);
      } else {
        pDataParams->wMaxNdefLength += (uint16_t)(((((uint16_t)(pMfcTop->bNdefSectorCount)) - ((uint16_t)(
                                pMfcTop->bFirstNdefSector)))) * PHAL_MFCTOP_SECTOR_DATA_SIZE * PHAL_MFCTOP_BLOCK_SIZE);
      }
