...
typedef phStatus_t (*pphalTop_Sw_CheckNdef)(phalTop_Sw_DataParams_t *pDataParams,
    uint8_t *pTagState);
...
typedef phStatus_t (*pphalTop_Sw_ReadNdef)(phalTop_Sw_DataParams_t *pDataParams,  uint8_t *pData,
    uint16_t *pLength);
typedef phStatus_t (*pphalTop_Sw_WriteNdef)(phalTop_Sw_DataParams_t *pDataParams,  uint8_t *pData,
    uint16_t  wLength);
