...
phbalReg_T1SamAV3_error_t phbalReg_T1SamAV3_ISO7816_snd_blocking(
	void *data,
	uint16_t len)
{
	nrfx_err_t error;
...
phbalReg_T1SamAV3_error_t phbalReg_T1SamAV3_ISO7816_rcv_blocking(
	void *data,
	...
	uint16_t *received_bytes)
{
	...
	*received_bytes = 0;
	...
	PN5180_LOG_ERROR("%s: Reading UART error %lX \n",__func__, nrfx_uarte_errorsrc_get(g_iso7816_cfg.uart_inst));
...
phbalReg_T1SamAV3_error_t phbalReg_T1SamAV3_ISO7816_transceive_blocking(
	void *data,
	uint16_t txLen,
	uint16_t *received_bytes)
{
