...
void phbalReg_T1SamAV3_delay(uint8_t ms)
{
	os_time_t ticks;
...
static uint8_t phbalReg_T1SamAV3_seq(phbalReg_T1SamAV3_DataParams_t *ctx)
{
...
static uint8_t phbalReg_T1SamAV3_lrc(const uint8_t *data, uint8_t data_len)
{
...
static phbalReg_T1SamAV3_error_t phbalReg_T1SamAV3_handle_rblock(phbalReg_T1SamAV3_DataParams_t *ctx, uint8_t *rblock)
{
...
static phbalReg_T1SamAV3_error_t phbalReg_T1SamAV3_transceive(
...
phbalReg_T1SamAV3_error_t phbalReg_T1SamAV3_uninit(phbalReg_T1SamAV3_DataParams_t *ctx) {
	phbalReg_T1SamAV3_error_t err = PHBAL_REG_T1SAMAV3_SUCCESS;
