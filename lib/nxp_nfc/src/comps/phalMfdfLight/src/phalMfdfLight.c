    ...
    uint8_t *bPcdCapsOut, uint8_t *bPdCapsOut)
{
  ...
  if (bDivLen) {
    PH_ASSERT_NULL_PARAM(pDivInput, PH_COMP_AL_MFDFLIGHT);
  }
  if (bLenPcdCapsIn) {
    PH_ASSERT_NULL_PARAM(bPcdCapsIn, PH_COMP_AL_MFDFLIGHT);
  }
  ...
  switch (PH_GET_COMPID(pDataParams)) {
    ...
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_AuthenticateEv2((phalMfdfLight_Sw_DataParams_t *)pDataParams,
              bFirstAuth, wOption, wKeyNo, wKeyVer, bKeyNoCard,
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_SetConfiguration((phalMfdfLight_Sw_DataParams_t *)pDataParams, bOption,
              pData, bDataLen);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_GetCardUID((phalMfdfLight_Sw_DataParams_t *)pDataParams, pUid,
              &bCardUidLength);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_GetVersion((phalMfdfLight_Sw_DataParams_t *)pDataParams, pVerInfo,
              &bVersionLength);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_ChangeKey((phalMfdfLight_Sw_DataParams_t *)pDataParams, wOption,
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_GetKeyVersion((phalMfdfLight_Sw_DataParams_t *)pDataParams, bKeyNo,
              bKeySetNo, pKeyVersion, bRxLen);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_CreateTransactionMacFile((phalMfdfLight_Sw_DataParams_t *)pDataParams,
              bFileNo, bCommMode, pAccessRights, bKeyType,
              bTMKey, bTMKeyVer);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
    ...
    uint8_t bTmcLimitLen, uint8_t *pTmcLimit)
{
  ...
  PH_ASSERT_NULL_PARAM(pAccessRights, PH_COMP_AL_MFDFLIGHT);
  if (bTmcLimitLen) {
    PH_ASSERT_NULL_PARAM(pTmcLimit, PH_COMP_AL_MFDFLIGHT);
  }
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_ChangeFileSettings((phalMfdfLight_Sw_DataParams_t *)pDataParams,
              bCommMode, bFileNo, bFileOption, pAccessRights, bTmcLimitLen,
              pTmcLimit);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_GetISOFileIDs((phalMfdfLight_Sw_DataParams_t *)pDataParams, pFidBuffer,
              pNumFID);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_GetFileSettings((phalMfdfLight_Sw_DataParams_t *)pDataParams, bFileNo,
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_ReadData((phalMfdfLight_Sw_DataParams_t *)pDataParams, bOption, bIns,
              bFileNo, pOffset, pLength, ppRxdata, pRxdataLen);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_WriteData((phalMfdfLight_Sw_DataParams_t *)pDataParams, bOption, bIns,
              bFileNo, pOffset, pTxData, pTxDataLen);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_GetValue((phalMfdfLight_Sw_DataParams_t *)pDataParams, bOption, bFileNo,
              pValue);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_Credit((phalMfdfLight_Sw_DataParams_t *)pDataParams, bOption, bFileNo,
              pValue);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_Debit((phalMfdfLight_Sw_DataParams_t *)pDataParams, bCommOption,
              bFileNo, pValue);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_LimitedCredit((phalMfdfLight_Sw_DataParams_t *)pDataParams, bCommOption,
              bFileNo, pValue);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_ReadRecords((phalMfdfLight_Sw_DataParams_t *)pDataParams, bCommOption,
              bIns, bFileNo, pRecNo, pRecCount, pRecSize,
              ppRxdata, pRxdataLen);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_WriteRecord((phalMfdfLight_Sw_DataParams_t *)pDataParams, bCommOption,
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_UpdateRecord((phalMfdfLight_Sw_DataParams_t *)pDataParams, bCommOption,
              bIns, bFileNo, pRecNo, pOffset,
              pData, pDataLen);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_CommitTransaction((phalMfdfLight_Sw_DataParams_t *)pDataParams, bOption,
              pTMC, pTMV);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_CommitReaderID((phalMfdfLight_Sw_DataParams_t *)pDataParams, pTMRI,
              pEncTMRI);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_IsoSelectFile((phalMfdfLight_Sw_DataParams_t *)pDataParams, bOption,
              bSelector, pFid, pDFname, bDFnameLen, bExtendedLenApdu,
              ppFCI, pwFCILen);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_IsoReadBinary((phalMfdfLight_Sw_DataParams_t *)pDataParams, wOption,
              bOffset, bSfid, dwBytesToRead, bExtendedLenApdu,
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_IsoUpdateBinary((phalMfdfLight_Sw_DataParams_t *)pDataParams, bOffset,
              bSfid, bExtendedLenApdu, pData, dwDataLen);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_ReadSign((phalMfdfLight_Sw_DataParams_t *)pDataParams, bAddr,
              pSignature);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_GetConfig((phalMfdfLight_Sw_DataParams_t *)pDataParams, wConfig,
              pValue);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_SetConfig((phalMfdfLight_Sw_DataParams_t *)pDataParams, wConfig,
              wValue);
      break;
#endif /* NXPBUILD__PHAL_MFDFLIGHT_SW */
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_CalculateTMV((phalMfdfLight_Sw_DataParams_t *)pDataParams, wOption,
              wKeyNoTMACKey, wKeyVerTMACKey, pDivInput, bDivInputLen,
...
#ifdef NXPBUILD__PHAL_MFDFLIGHT_SW
    case PHAL_MFDFLIGHT_SW_ID:
      status = phalMfdfLight_Sw_DecryptReaderID((phalMfdfLight_Sw_DataParams_t *)pDataParams, wOption,
