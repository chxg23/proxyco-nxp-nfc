...
)
{
  ...
  PH_LOG_HELPER_ALLOCATE_PARAMNAME(status);
  PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_INFO, pTxServiceList_log, pTxServiceList,
      bTxNumServices);
  PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
  PH_ASSERT_NULL(pDataParams);
...
#ifdef NXPBUILD__PHAL_FELICA_SW
    case PHAL_FELICA_SW_ID:
      status = phalFelica_Sw_RequestService((phalFelica_Sw_DataParams_t *)pDataParams, bTxNumServices,
              pTxServiceList, pRxNumServices, pRxServiceList);
      break;
#endif /* NXPBUILD__PHAL_FELICA_SW */
  ...
  PH_LOG_HELPER_ADDSTRING(PH_LOG_LOGTYPE_INFO, bFunctionName);
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_INFO, pRxServiceList_log, pRxServiceList,
      *pRxNumServices);
  PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_INFO, status_log, &status);
  PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_LEAVE);
...
#ifdef NXPBUILD__PHAL_FELICA_SW
    case PHAL_FELICA_SW_ID:
      status = phalFelica_Sw_Read((phalFelica_Sw_DataParams_t *)pDataParams, bNumServices, pServiceList,
              bTxNumBlocks, pBlockList, bBlockListLength, pRxNumBlocks, pBlockData);
      break;
#endif /* NXPBUILD__PHAL_FELICA_SW */
...
#ifdef NXPBUILD__PHAL_FELICA_SW
    case PHAL_FELICA_SW_ID:
      status = phalFelica_Sw_Write((phalFelica_Sw_DataParams_t *)pDataParams,  bNumServices,
              pServiceList, bNumBlocks, pBlockList, bBlockListLength, pBlockData);
      break;
#endif /* NXPBUILD__PHAL_FELICA_SW */
