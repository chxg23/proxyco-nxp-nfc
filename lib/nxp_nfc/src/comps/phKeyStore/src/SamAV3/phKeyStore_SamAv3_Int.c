 ...
 */
phStatus_t
phKeyStore_SamAV3_Int_GetKeyEntry(phKeyStore_SamAV3_DataParams_t *pDataParams, uint8_t bKeyNo,
    uint8_t bIsRamKey,
    phKeyStore_SamAV3_KeyEntry_t *pKeyEntry)
{
  ...
  if (!bIsRamKey) {
    bKeyEntryFormat = (uint8_t)(wHostMode == PHHAL_HW_SAMAV3_HC_AV2_MODE) ?
 ...
 */
phStatus_t
phKeyStore_SamAV3_Int_ConvertKeyEntryToBuffer(phKeyStore_SamAV3_DataParams_t *pDataParams,
    phKeyStore_SamAV3_KeyEntry_t *pKeyEntry,
 ...
 */
phStatus_t
phKeyStore_SamAV3_Int_SetKeyType(phKeyStore_SamAV3_KeyEntry_t *pKeyEntry, uint16_t wKeyType,
 ...
 */
phStatus_t
phKeyStore_SamAV3_Int_GetKeyType(phKeyStore_SamAV3_KeyEntry_t *pKeyEntry, uint16_t *pKeyType,
    uint8_t *pIsLRPKey)
{
 ...
 */
phStatus_t
phKeyStore_SamAV3_Int_GetKeySize(uint16_t wKeyType, uint8_t *pKeySize)
{
  switch (wKeyType) {
    case PH_KEYSTORE_KEY_TYPE_MIFARE:
    case PH_KEYSTORE_KEY_TYPE_AES128:
