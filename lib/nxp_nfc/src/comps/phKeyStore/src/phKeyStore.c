...
)
{
  ...
  switch (PH_GET_COMPID(pDataParams)) {
    ...
    case PH_KEYSTORE_SW_ID:
      status = phKeyStore_Sw_FormatKeyEntry((phKeyStore_Sw_DataParams_t *)pDataParams, wKeyNo,
              wNewKeyType);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_SW */
    ...
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_FormatKeyEntry((phKeyStore_Rc663_DataParams_t *)pDataParams, wKeyNo,
              wNewKeyType);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_RC663 */
...
)
{
  ...
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pNewKey_log, pNewKey,
      phKeyStore_GetKeySize(wKeyType));
...
#ifdef NXPBUILD__PH_KEYSTORE_SW
    case PH_KEYSTORE_SW_ID:
      status = phKeyStore_Sw_SetKey((phKeyStore_Sw_DataParams_t *)pDataParams, wKeyNo, wKeyVersion,
...
#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_SetKey((phKeyStore_Rc663_DataParams_t *)pDataParams, wKeyNo,
...
#ifdef NXPBUILD__PH_KEYSTORE_SW
    case PH_KEYSTORE_SW_ID:
      status = phKeyStore_Sw_SetKeyAtPos((phKeyStore_Sw_DataParams_t *)pDataParams, wKeyNo, wPos,
              wKeyType, pNewKey, wNewKeyVersion);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_SW */
...
#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_SetKeyAtPos((phKeyStore_Rc663_DataParams_t *)pDataParams, wKeyNo, wPos,
              wKeyType, pNewKey, wNewKeyVersion);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_RC663 */
...
#ifdef NXPBUILD__PH_KEYSTORE_SAMAV3
    case PH_KEYSTORE_SAMAV3_ID:
        status = phKeyStore_SamAV3_SetKeyAtPos((phKeyStore_SamAV3_DataParams_t *)pDataParams, wKeyNo, wPos,
        	  wKeyType, pNewKey, wNewKeyVersion);
        break;
#endif /* NXPBUILD__PH_KEYSTORE_SAMAV3 */
...
)
{
  ...
  PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, wNewKeyType_log, &wNewKeyType);
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pNewKeys_log, pNewKeys,
      phKeyStore_GetKeySize(wNewKeyType)*wNoOfKeys);
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pNewKeyVersionList_log, pNewKeyVersionList,
      wNoOfKeys);
  PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_ENTER);
  PH_ASSERT_NULL(pDataParams);
...
#ifdef NXPBUILD__PH_KEYSTORE_SW
    case PH_KEYSTORE_SW_ID:
      status = phKeyStore_Sw_SetFullKeyEntry((phKeyStore_Sw_DataParams_t *)pDataParams, wNoOfKeys,
              wKeyNo, wNewRefNoKUC, wNewKeyType, pNewKeys, pNewKeyVersionList);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_SW */

#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_SetFullKeyEntry((phKeyStore_Rc663_DataParams_t *)pDataParams, wNoOfKeys,
              wKeyNo, wNewRefNoKUC, wNewKeyType, pNewKeys, pNewKeyVersionList);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_RC663 */
...
)
{
...
#ifdef NXPBUILD__PH_KEYSTORE_SW
    case PH_KEYSTORE_SW_ID:
      status = phKeyStore_Sw_GetKeyEntry((phKeyStore_Sw_DataParams_t *)pDataParams, wKeyNo,
              wKeyVersionBufSize, wKeyVersion, wKeyVersionLength, pKeyType);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_SW */

#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_GetKeyEntry((phKeyStore_Rc663_DataParams_t *)pDataParams, wKeyNo,
              wKeyVersionBufSize, wKeyVersion, wKeyVersionLength, pKeyType);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_RC663 */
  ...
  if ((status & PH_ERR_MASK) == PH_ERR_SUCCESS) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, wKeyVersion_log, wKeyVersion,
        *wKeyVersionLength);
...
#ifdef NXPBUILD__PH_KEYSTORE_SW
    case PH_KEYSTORE_SW_ID:
      status = phKeyStore_Sw_GetKey((phKeyStore_Sw_DataParams_t *)pDataParams, wKeyNo, wKeyVersion,
              bKeyBufSize, pKey, pKeyType);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_SW */

#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_GetKey((phKeyStore_Rc663_DataParams_t *)pDataParams, wKeyNo,
...
#ifdef NXPBUILD__PH_LOG
  if ((status & PH_ERR_MASK) == PH_ERR_SUCCESS) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pKey_log, pKey,
        phKeyStore_GetKeySize(*pKeyType));
    PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_DEBUG, pKeyType_log, pKeyType);
  }
#endif
  PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_INFO, status_log, &status);
...
#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_SetConfig((phKeyStore_Rc663_DataParams_t *)pDataParams, wConfig,
              wValue);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_RC663 */
...
#ifdef NXPBUILD__PH_KEYSTORE_SW
    case PH_KEYSTORE_SW_ID:
      status = phKeyStore_Sw_SetConfigStr((phKeyStore_Sw_DataParams_t *)pDataParams, wConfig, pBuffer,
              wBufferLength);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_SW */
...
#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_SetConfigStr((phKeyStore_Rc663_DataParams_t *)pDataParams, wConfig,
...
#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_GetConfig((phKeyStore_Rc663_DataParams_t *)pDataParams, wConfig,
              pValue);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_RC663 */
...
#ifdef NXPBUILD__PH_KEYSTORE_SW
    case PH_KEYSTORE_SW_ID:
      status = phKeyStore_Sw_GetConfigStr((phKeyStore_Sw_DataParams_t *)pDataParams, wConfig, ppBuffer,
              pBufferLength);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_SW */
...
#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_GetConfigStr((phKeyStore_Rc663_DataParams_t *)pDataParams, wConfig,
...
#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_ChangeKUC((phKeyStore_Rc663_DataParams_t *)pDataParams, wRefNoKUC,
              dwLimit);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_RC663 */
...
#ifdef NXPBUILD__PH_KEYSTORE_SW
    case PH_KEYSTORE_SW_ID:
      status = phKeyStore_Sw_GetKUC((phKeyStore_Sw_DataParams_t *)pDataParams, wRefNoKUC, pdwLimit,
              pdwCurVal);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_SW */
...
#ifdef NXPBUILD__PH_KEYSTORE_RC663
    case PH_KEYSTORE_RC663_ID:
      status = phKeyStore_Rc663_GetKUC((phKeyStore_Rc663_DataParams_t *)pDataParams, wRefNoKUC,
              pdwLimit, pdwCurVal);
      break;
#endif /* NXPBUILD__PH_KEYSTORE_RC663 */
