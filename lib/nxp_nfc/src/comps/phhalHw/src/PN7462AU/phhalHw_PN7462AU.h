...
#include "nxp_nfc/ph_Datatypes.h"
...
*/
phStatus_t phhalHw_PN7462AU_SetConfig(phhalHw_PN7462AU_DataParams_t
    *pDataParams,  /**< [In] Data parameters */
...
*/
phStatus_t phhalHw_PN7462AU_GetConfig(phhalHw_PN7462AU_DataParams_t
    *pDataParams,  /**< [In] Data parameters */
    uint16_t wConfig, /**< [In] Configuration Identifier. */
...
* \retval #PH_ERR_SUCCESS Operation successful.
*/
phStatus_t phhalHw_PN7462AU_FieldOn(phhalHw_PN7462AU_DataParams_t
    *pDataParams);   /**< [In] Data parameters */
...
* \retval #PH_ERR_SUCCESS Operation successful.
*/
phStatus_t phhalHw_PN7462AU_FieldOff(phhalHw_PN7462AU_DataParams_t
    *pDataParams);    /**< [In] Data parameters */
...
* \retval #PH_ERR_SUCCESS Operation successful.
*/
phStatus_t phhalHw_PN7462AU_ApplyProtocolSettings(phhalHw_PN7462AU_DataParams_t
    *pDataParams,   /**< [In] Data parameters */
...
* \retval #PH_ERR_SUCCESS Operation successful.
*/
phStatus_t phhalHw_PN7462AU_Exchange(phhalHw_PN7462AU_DataParams_t
    *pDataParams,    /**< [In] Data parameters */
 ...
 *\retval #PH_ERR_SUCCESS Operation successful.
 */
phStatus_t phhalHw_PN7462AU_Wait(phhalHw_PN7462AU_DataParams_t *pDataParams, uint8_t bUnit,
    uint16_t wTimeout);
...
phStatus_t phhalHw_PN7462AU_Autocoll(phhalHw_PN7462AU_DataParams_t *pDataParams, uint16_t wMode,
    uint8_t **ppRxBuffer, uint16_t *pRxLength, uint16_t *pProtParams);
