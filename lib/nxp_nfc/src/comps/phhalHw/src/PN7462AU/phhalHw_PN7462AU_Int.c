...
#include "nxp_nfc/PN7462AU/PN7462AU_clif.h"
...
)
{
  ...
  PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_SetConfig(pDataParams,
          PHHAL_HW_CONFIG_PN7462AU_CRCPRESET_SEL, PHHAL_HW_PN7462AU_I18000P3M3_SELECT_PRESET));
  ...
  PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_SetConfig(pDataParams,
          PHHAL_HW_CONFIG_PN7462AU_CRCPRESET_SEL, PHHAL_HW_PN7462AU_I18000P3M3_NONSELECT_PRESET));
...
)
{
  ...
  PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_SetConfig(
          pDataParams,
          PHHAL_HW_CONFIG_TIMEOUT_VALUE_US,
          PHHAL_HW_PN7462AU_I18000P3M3_SW_T1_MAX_US + PHHAL_HW_PN7462AU_I18000P3M3_SW_T3_MIN_US +
          PHHAL_HW_PN7462AU_I18000P3M3_SW_DELTA_MIN_US));
  ...
  /* Save StoredCRC */
  phUser_MemCpy(pDataParams->abStoredCRC, &pResponse[pDataParams->wRxBufStartPos],
      2);  /* PRQA S 3200 */
...
)
{
  ...
  /* Build Command frame */
  aCmd[0] = (PHHAL_HW_PN7462AU_I18000P3M3_CMD_NEXT_SLOT << 4U) | (pDataParams->bSession <<
          2U); /* 2 bits left */
...
)
{
  ...
  /* Build Command frame */
  aCmd[0] = (PHHAL_HW_PN7462AU_I18000P3M3_CMD_ACK << 6U) | (pDataParams->abStoredCRC[0] >>
          2U);    /* 0 bits left */
...
)
{
  ...
  PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_SetConfig(pDataParams,
          PHHAL_HW_CONFIG_PN7462AU_CRCPRESET_SEL, 0x03));
