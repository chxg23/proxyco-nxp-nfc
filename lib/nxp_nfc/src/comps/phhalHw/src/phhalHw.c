...
)
{
  ...
  switch (PH_GET_COMPID(pDataParams)) {
#ifdef NXPBUILD__PHHAL_HW_RC663
    case PHHAL_HW_RC663_ID:
      status = phhalHw_Rc663_Exchange((phhalHw_Rc663_DataParams_t *)pDataParams, wOption, pTxBuffer,
    ...
    case PHHAL_HW_PN5180_ID:
      status = phhalHw_Pn5180_Exchange((phhalHw_Pn5180_DataParams_t *)pDataParams, wOption, pTxBuffer,
              wTxLength, ppRxBuffer, pRxLength);
      break;
#endif  /* NXPBUILD__PHHAL_HW_PN5180 */
    ...
    case PHHAL_HW_PN5190_ID:
      status = phhalHw_Pn5190_Exchange((phhalHw_Pn5190_DataParams_t *)pDataParams, wOption, pTxBuffer,
              wTxLength, ppRxBuffer, pRxLength);
      break;
#endif  /* NXPBUILD__PHHAL_HW_PN5190 */
...
#ifdef NXPBUILD__PHHAL_HW_RC663
    case PHHAL_HW_RC663_ID:
      status = phhalHw_Rc663_Transmit((phhalHw_Rc663_DataParams_t *)pDataParams, wOption, pTxBuffer,
              wTxLength);
      break;
#endif /* NXPBUILD__PHHAL_HW_RC663 */
...
#ifdef NXPBUILD__PHHAL_HW_PN5180
    case PHHAL_HW_PN5180_ID:
      status = phhalHw_Pn5180_Transmit((phhalHw_Pn5180_DataParams_t *)pDataParams, wOption, pTxBuffer,
              wTxLength);
      break;
#endif /* NXPBUILD__PHHAL_HW_PN5180 */
...
#ifdef NXPBUILD__PHHAL_HW_PN5190
    case PHHAL_HW_PN5190_ID:
      status = phhalHw_Pn5190_Transmit((phhalHw_Pn5190_DataParams_t *)pDataParams, wOption, pTxBuffer,
              wTxLength);
      break;
#endif /* NXPBUILD__PHHAL_HW_PN5190 */
...
#ifdef NXPBUILD__PHHAL_HW_RC663
    case PHHAL_HW_RC663_ID:
      status = phhalHw_Rc663_Receive((phhalHw_Rc663_DataParams_t *)pDataParams, wOption, ppRxBuffer,
              pRxLength);
      break;
#endif /* NXPBUILD__PHHAL_HW_RC663 */
...
#ifdef NXPBUILD__PHHAL_HW_PN5180
    case PHHAL_HW_PN5180_ID:
      status = phhalHw_Pn5180_Receive((phhalHw_Pn5180_DataParams_t *)pDataParams, wOption, ppRxBuffer,
              pRxLength);
      break;
#endif /* NXPBUILD__PHHAL_HW_PN5180 */
...
#ifdef NXPBUILD__PHHAL_HW_PN5190
    case PHHAL_HW_PN5190_ID:
      status = phhalHw_Pn5190_Receive((phhalHw_Pn5190_DataParams_t *)pDataParams, wOption, ppRxBuffer,
              pRxLength);
      break;
#endif /* NXPBUILD__PHHAL_HW_PN5190 */
...
#ifdef NXPBUILD__PHHAL_HW_PN5180
    case PHHAL_HW_PN5180_ID:
      status = phhalHw_Pn5180_Autocoll((phhalHw_Pn5180_DataParams_t *)pDataParams, wMode, ppRxBuffer,
              pRxLength, pProtParams);
      break;
#endif /* NXPBUILD__PHHAL_HW_PN5180 */

#ifdef NXPBUILD__PHHAL_HW_PN5190
    case PHHAL_HW_PN5190_ID:
      status = phhalHw_Pn5190_Autocoll((phhalHw_Pn5190_DataParams_t *)pDataParams, wMode, ppRxBuffer,
              pRxLength, pProtParams);
      break;
#endif /* NXPBUILD__PHHAL_HW_PN5190 */
...
)
{
  ...
  PH_LOG_HELPER_ADDPARAM_UINT8(PH_LOG_LOGTYPE_DEBUG, bNumValidBitsinLastByte_log,
