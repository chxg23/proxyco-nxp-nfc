...
#endif
  phbalReg_Type_t cfg;
  phhalHw_Pn5180_DataParams_t *data_params;
};
...
struct pn5180_itf {
  ...
  uint8_t pi_cs_pin;
#endif
  struct pn5180_int pi_ints[MYNEWT_VAL(PN5180_MAX_INTERRUPTS_PINS)];
};
...
phStatus_t phhalHw_Pn5180_ReadRegister(
    ...
    *pDataParams,           /**<[In] DataParams representing this layer. */
