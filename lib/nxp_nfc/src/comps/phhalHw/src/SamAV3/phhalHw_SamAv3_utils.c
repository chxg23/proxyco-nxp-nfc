...
phhalHw_SamAV3_HcUtils_FirstIv[PH_CRYPTOSYM_AES_BLOCK_SIZE] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};

phStatus_t
phhalHw_SamAV3_Utils_GetCheckLcLe(uint8_t *pCmd, uint16_t wCmdLen, uint8_t *pIsLcPresent,
    uint8_t  *pLcLen, uint8_t *pIsLePresent)
{
  ...
  /* @3*/
          ...
          pCmd[PHHAL_HW_SAMAV3_ISO7816_LC_POS])) {
  ...
  /* @4*/
  else if (wCmdLen == (PHHAL_HW_SAMAV3_ISO7816_HEADER_LE_LENGTH +
          pCmd[PHHAL_HW_SAMAV3_ISO7816_LC_POS])) {
    *pLcLen = pCmd[PHHAL_HW_SAMAV3_ISO7816_LC_POS];
    *pIsLcPresent = PH_ON;
    *pIsLePresent = PH_ON;
...
phStatus_t
phhalHw_SamAV3_Utils_TruncateMacBuffer(uint8_t *pIoBuffer, uint8_t *pMacLen)
{
...
phStatus_t
phhalHw_SamAV3_Utils_ResolveErrorCode(uint8_t *pSw1Sw2)
{
...
phStatus_t
phhalHw_SamAV3_Utils_GenerateHostAuthSessionKey(phhalHw_SamAV3_DataParams_t *pDataParams,
    uint8_t bKeyType, uint8_t *pRnd1, uint8_t *pRnd2,
...
phStatus_t
phhalHw_SamAV3_Utils_GenerateSessionKey(phhalHw_SamAV3_DataParams_t *pDataParams,
    uint8_t bKeyType, uint8_t *pRnd1, uint8_t *pRnd2,
...
phStatus_t
phhalHw_SamAV3_Utils_GetSessionUploadKey(phhalHw_SamAV3_DataParams_t *pDataParams, uint8_t bMode,
    uint16_t wUploadCtr, uint8_t bKeyNo,
    uint8_t bKeyVer, uint8_t *pSessionKey, uint8_t *pKeyType)
{
  ...
  *pKeyType = (uint8_t) wKeyType;
  ...
  switch (wKeyType) {
    case PH_KEYSTORE_KEY_TYPE_AES128:
      memset(aSva, (uint8_t)((bMode == PHHAL_HW_CMD_SAMAV3_SESSION_KEY_ENC) ? 0x71 : 0x72),
          sizeof(aSva));	/* PRQA S 3200 */
    ...
    case PH_KEYSTORE_KEY_TYPE_AES192:
      memset(aSva, (uint8_t)((bMode == PHHAL_HW_CMD_SAMAV3_SESSION_KEY_ENC) ? 0x73 : 0x75),
          sizeof(aSva));	/* PRQA S 3200 */
      memset(aSvb, (uint8_t)((bMode == PHHAL_HW_CMD_SAMAV3_SESSION_KEY_ENC) ? 0x74 : 0x76),
          sizeof(aSvb));	/* PRQA S 3200 */
      ...
      aSessionKey[0x08] = (uint8_t)(aSessionKeyA[0x08] ^ aSessionKeyB[0x00]);
      aSessionKey[0x10] = aSessionKeyB[0x08];
      aSessionKey[0x01] = aSessionKeyA[0x01];
      aSessionKey[0x09] = (uint8_t)(aSessionKeyA[0x09] ^ aSessionKeyB[0x01]);
      aSessionKey[0x11] = aSessionKeyB[0x09];
      aSessionKey[0x02] = aSessionKeyA[0x02];
      aSessionKey[0x0A] = (uint8_t)(aSessionKeyA[0x0A] ^ aSessionKeyB[0x02]);
      aSessionKey[0x12] = aSessionKeyB[0x0A];
      aSessionKey[0x03] = aSessionKeyA[0x03];
      aSessionKey[0x0B] = (uint8_t)(aSessionKeyA[0x0B] ^ aSessionKeyB[0x03]);
      aSessionKey[0x13] = aSessionKeyB[0x0B];
      aSessionKey[0x04] = aSessionKeyA[0x04];
      aSessionKey[0x0C] = (uint8_t)(aSessionKeyA[0x0C] ^ aSessionKeyB[0x04]);
      aSessionKey[0x14] = aSessionKeyB[0x0C];
      aSessionKey[0x05] = aSessionKeyA[0x05];
      aSessionKey[0x0D] = (uint8_t)(aSessionKeyA[0x0D] ^ aSessionKeyB[0x05]);
      aSessionKey[0x15] = aSessionKeyB[0x0D];
      aSessionKey[0x06] = aSessionKeyA[0x06];
      aSessionKey[0x0E] = (uint8_t)(aSessionKeyA[0x0E] ^ aSessionKeyB[0x06]);
      aSessionKey[0x16] = aSessionKeyB[0x0E];
      aSessionKey[0x07] = aSessionKeyA[0x07];
      aSessionKey[0x0F] = (uint8_t)(aSessionKeyA[0x0F] ^ aSessionKeyB[0x07]);
      aSessionKey[0x17] = aSessionKeyB[0x0F];
    ...
    case PH_KEYSTORE_KEY_TYPE_AES256:
      memset(aSva, (uint8_t)((bMode == PHHAL_HW_CMD_SAMAV3_SESSION_KEY_ENC) ? 0x77 : 0x79),
          sizeof(aSva));	/* PRQA S 3200 */
      memset(aSvb, (uint8_t)((bMode == PHHAL_HW_CMD_SAMAV3_SESSION_KEY_ENC) ? 0x78 : 0x7A),
          sizeof(aSvb));	/* PRQA S 3200 */
