...
#include <nxp_nfc/phhalHw_Pn5190_Instr.h>
#include "phhalHw_Pn5190_Int.h"
#include <nxp_nfc/phhalHw_Pn5190_Reg.h>
...
phStatus_t
phhalHw_Pn5190_Instr_TransmitRFData(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint16_t wOption,
    uint8_t bTxLastBits,
    uint8_t *pTxBuffer,
...
)
{
  ...
  * */
  if (((pTxBuffer == NULL) && (wTxBufferLength != 0U) &&
          ((wOption & PH_TRANSMIT_PREV_FRAME) == 0)) ||
...
phStatus_t
phhalHw_Pn5190_Instr_ReceiveRFData(
    phhalHw_Pn5190_DataParams_t *pDataParams,
...
phStatus_t
phhalHw_Pn5190_Instr_ExchangeRFData(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint16_t wOption,
    uint8_t bTxLastBits,
...
phStatus_t
phhalHw_Pn5190_Instr_SwitchModeStandby(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint8_t bConfigMask,
...
phStatus_t
phhalHw_Pn5190_Instr_LPCD_SetConfig(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint16_t wConfig,
    uint32_t dwValue
)
{
  ...
  switch (wConfig) {
    ...
    case PHHAL_HW_CONFIG_LPCD_MODE:
      if ((dwValue == PHHAL_HW_PN5190_LPCD_MODE_DEFAULT) ||
          (dwValue ==  PHHAL_HW_PN5190_LPCD_MODE_POWERDOWN)) {
...
phStatus_t
phhalHw_Pn5190_Instr_LPCD_GetConfig(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint16_t wConfig,
    uint32_t *pValue
)
...
phStatus_t
phhalHw_Pn5190_Instr_SwitchModeLpcd(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint8_t bLpcdMode,
...
phStatus_t
phhalHw_Pn5190_Instr_SwitchModeAutocoll(
    phhalHw_Pn5190_DataParams_t *pDataParams,
...
phStatus_t
phhalHw_Pn5190_Instr_SwitchModeBootNormal(
    phhalHw_Pn5190_DataParams_t *pDataParams
)
{
...
phStatus_t
phhalHw_Pn5190_Instr_SwitchModeNormal(
    phhalHw_Pn5190_DataParams_t *pDataParams
)
{
  uint8_t    PH_MEMLOC_REM aCmd[4] = {0};
...
phStatus_t
phhalHw_Pn5190_Instr_MifareAuthenticate(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint8_t *pKey,
    uint8_t bKeyType,
    uint8_t bBlockNo,
...
)
{
  ...
  if (PH_ERR_PN5190_SUCCESS == status) {
    /* Check auth success */
    PH_CHECK_SUCCESS_FCT(statusTmp, phhalHw_Pn5190_Instr_ReadRegister(pDataParams, SYSTEM_CONFIG,
            &dwRegister));
...
)
{
  ...
  */
  ...
  /* Copy the Instruction payload and update the buffer length*/
  (void)memcpy(&aCmdBuffer[wBufferLength], pBeginRoundCommand,
      PHHAL_HW_PN5190_BEGIN_COMMAND_LENGTH);
...
)
{
  ...
  if (((bRfTxConfiguration > PHHAL_HW_PN5190_MAX_RF_TX_CONFIGURATION_INDEX) &&
          (bRfTxConfiguration != 0xFFU)) ||
...
phStatus_t
phhalHw_Pn5190_Instr_ConfigureTestBusDigital(
    phhalHw_Pn5190_DataParams_t *pDataParams,
...
phStatus_t
phhalHw_Pn5190_Instr_ConfigureTestBusAnalog(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint8_t bConfig,
...
phStatus_t
phhalHw_Pn5190_Instr_CtsEnable(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint8_t bOption
)
{
...
phStatus_t
phhalHw_Pn5190_Instr_CtsConfig(
    phhalHw_Pn5190_DataParams_t *pDataParams,
...
phStatus_t
phhalHw_Pn5190_Instr_CtsRetrieveLog(
    phhalHw_Pn5190_DataParams_t *pDataParams,
    uint8_t bChunkSize,
    uint8_t *pLogData,
...
phStatus_t
phhalHw_Pn5190_Instr_GetDieId(phhalHw_Pn5190_DataParams_t *pDataParams,
    uint8_t *pDieIdValue)
{
  phStatus_t PH_MEMLOC_REM status = PH_ERR_PN5190_SUCCESS;
  phhalHw_InstMngr_CmdParams_t sCmdParams = {0U};
...
phStatus_t
phhalHw_Pn5190_Instr_GetVersion(phhalHw_Pn5190_DataParams_t *pDataParams,
...
phStatus_t
phhalHw_Pn5190_Instr_SwitchModeDownload(phhalHw_Pn5190_DataParams_t *pDataParams)
{
  phStatus_t PH_MEMLOC_REM status = PH_ERR_PN5190_SUCCESS;
  phhalHw_InstMngr_CmdParams_t sCmdParams = {0U};
  uint16_t   PH_MEMLOC_REM wRxLen = 0U;
...
phStatus_t
phhalHw_Pn5190_Instr_PrbsTest(phhalHw_Pn5190_DataParams_t *pDataParams,
    uint8_t bPrbs_type)
{
  phStatus_t PH_MEMLOC_REM status = PH_ERR_PN5190_SUCCESS;
