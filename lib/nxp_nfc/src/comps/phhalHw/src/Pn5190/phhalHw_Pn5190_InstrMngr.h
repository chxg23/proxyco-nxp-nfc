...
phStatus_t phhalHw_Pn5190_InstMngr_HandleCmd(
    ...
    *pDataParams,       /**< [In] Pointer to Pn5190 Hal layer's parameter structure. */
    phhalHw_InstMngr_CmdParams_t
    *pCmdParams,       /**< [In] Pointer to Instruction Manager's Cmd parameter structure. */
...
phStatus_t phhalHw_Pn5190_InstMngr_ReadRsp(
    ...
    *pDataParams,       /**< [In] Pointer to Pn5190 Hal layer's parameter structure. */
    phhalHw_InstMngr_CmdParams_t
    *pCmdParams        /**< [In] Pointer to Current Command Under-Process. */
);
