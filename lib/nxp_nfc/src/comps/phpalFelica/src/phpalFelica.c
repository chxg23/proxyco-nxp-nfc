...
)
{
  ...
  switch (PH_GET_COMPID(pDataParams)) {
    ...
    case PHPAL_FELICA_SW_ID:
      status = phpalFelica_Sw_ReqC((phpalFelica_Sw_DataParams_t *)pDataParams, pSystemCode, bTimeSlot,
  ...
  if ((status & PH_ERR_MASK) == PH_ERR_SUCCESS) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_DEBUG, pRxBuffer_log, ppRxBuffer,
        PHPAL_FELICA_IDM_LENGTH + PHPAL_FELICA_PMM_LENGTH);
  }
#endif
  PH_LOG_HELPER_ADDPARAM_UINT16(PH_LOG_LOGTYPE_INFO, status_log, &status);
  PH_LOG_HELPER_EXECUTE(PH_LOG_OPTION_CATEGORY_LEAVE);
...
)
{
  ...
  PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_INFO, pSystemCode_log, pSystemCode, 2);
  if (0U != (bIDmPMmLength)) {
    PH_LOG_HELPER_ADDPARAM_BUFFER(PH_LOG_LOGTYPE_INFO, pIDmPMm_log, pIDmPMm, bIDmPMmLength);
  }
...
#ifdef NXPBUILD__PHPAL_FELICA_SW
    case PHPAL_FELICA_SW_ID:
      status = phpalFelica_Sw_ActivateCard((phpalFelica_Sw_DataParams_t *)pDataParams, pIDmPMm,
              bIDmPMmLength, pSystemCode, bTimeSlot, pRxBuffer, pRxLength, pMoreCardsAvailable);
      break;
#endif /* NXPBUILD__PHPAL_FELICA_SW */
...
#ifdef NXPBUILD__PHPAL_FELICA_SW
    case PHPAL_FELICA_SW_ID:
      status = phpalFelica_Sw_Exchange((phpalFelica_Sw_DataParams_t *)pDataParams, wOption, wN,
...
#ifdef NXPBUILD__PHPAL_FELICA_SW
    case PHPAL_FELICA_SW_ID:
      status = phpalFelica_Sw_GetSerialNo((phpalFelica_Sw_DataParams_t *)pDataParams, pIDmPMmOut,
              pLenIDmPMmOut);
      break;
#endif /* NXPBUILD__PHPAL_FELICA_SW */
...
#ifdef NXPBUILD__PHPAL_FELICA_SW
    case PHPAL_FELICA_SW_ID:
      status = phpalFelica_Sw_GetFrameInfo((phpalFelica_Sw_DataParams_t *) pDataParams, bFrameNum,
              pResponseBuffer, pwStatus, ppID, pLen);
      break;
#endif /* NXPBUILD__PHPAL_FELICA_SW */
