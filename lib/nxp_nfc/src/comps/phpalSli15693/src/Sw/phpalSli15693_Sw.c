      ...
      if (bStoredUidLength < PHPAL_SLI15693_UID_LENGTH) {
        ...
        if (0U != (pDataParams->bUidBitLength % 8U)) {
          if (bStoredUidLength < 7U) {
            ...
            (void)memcpy(&(pDataParams->pUid[bStoredUidLength + 1U]), &pResp[1],
                ((uint32_t)(*pUidLength) - 1U));
          }
...
)
{
  ...
  if ((0U == ((pDataParams->bFlags & PHPAL_SLI15693_FLAG_INVENTORY))) &&
      (0U != ((pDataParams->bFlags & PHPAL_SLI15693_FLAG_ADDRESSED)))) {
  ...
  if ((0U == ((wOption & PH_EXCHANGE_LEAVE_BUFFER_BIT)))) {
    ...
    if ((pTxBuffer[0] > PHPAL_SLI15693_SW_CUSTOM_CMD_CODE_BEGIN) &&
        (pTxBuffer[0] < PHPAL_SLI15693_SW_CUSTOM_CMD_CODE_END)) {
...
)
{
  ...
  /* Check option byte */
  if ((bOption != PHPAL_SLI15693_ACTIVATE_ADDRESSED) &&
      (bOption != PHPAL_SLI15693_ACTIVATE_SELECTED)) {
    return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_PARAMETER, PH_COMP_PAL_SLI15693);
  }
  ...
  *pMoreCardsAvailable = 0;
  ...
  status = phpalSli15693_Sw_Inventory(pDataParams, bFlags, bAfi, pMask, bMaskBitLength, pDsfid,
          pUid);
  ...
  bMaskByteLength = ((bMaskBitLength % 8U) != 0U) ? ((bMaskBitLength >> 3U) + 1U) :
      (bMaskBitLength >> 3U);
      ...
      switch (status & PH_ERR_MASK) {
        ...
        case PH_ERR_INTEGRITY_ERROR:
          ...
          *pMoreCardsAvailable = 1;
          ...
          bSlot = 0;
          status = phpalSli15693_Sw_Inventory(pDataParams, bFlags, bAfi, aMaskBuffer, bMaskBitLength,
                  pDsfid, pUid);
          break;
    ...
    while (bMaskBitLength < PHPAL_SLI15693_SW_UID_COMPLETE) {
      switch (status & PH_ERR_MASK) {
        ...
        case PH_ERR_IO_TIMEOUT:
          ...
          aMaskBuffer[(uint8_t)(bMaskBitLength - 1U) >> 3U] = aMaskBuffer[(uint8_t)(
                      bMaskBitLength - 1U) >> 3U] ^ (uint8_t)(0x01U << (uint8_t)((bMaskBitLength - 1U) % 8U));
          bTimeOutNotAllowed = 1;
          break;
...
)
{
  ...
  if (((pUidLength == NULL) || (pUid == NULL)) ||
      ((0U != ((bExtendedOptions & PHPAL_SLI15693_FLAG_SKIP_DATA))) && ((pDataLength == NULL) ||
              (pData == NULL)))) {
    return PH_ADD_COMPCODE_FIXED(PH_ERR_INVALID_PARAMETER, PH_COMP_PAL_SLI15693);
  }
  ...
  *pDataLength = 0;
  ...
  if ((0U != ((bFlags & PHPAL_SLI15693_FLAG_AFI))) &&
      (0U != ((bFlags & PHPAL_SLI15693_FLAG_INVENTORY)))) {
  ...
  if ((((pDataParams->bFlags & PHPAL_SLI15693_FLAG_INVENTORY) == 0U) &&
          ((pDataParams->bFlags & PHPAL_SLI15693_FLAG_ADDRESSED) != 0U)) != 0U) {
  ...
  do {
    ...
    if ((status & PH_ERR_MASK) != PH_ERR_SUCCESS) {
      pDataParams->bFlags &= (uint8_t)~(uint8_t)(PHPAL_SLI15693_FLAG_INVENTORY | PHPAL_SLI15693_FLAG_AFI
