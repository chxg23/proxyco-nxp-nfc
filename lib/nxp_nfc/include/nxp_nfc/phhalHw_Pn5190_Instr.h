...
#define PHHAL_HW_PN5190_REG_END_ADDRESS             0x5DU
...
phStatus_t phhalHw_Pn5190_Instr_CtsConfig(
    ...
    *pDataParams,         /**< [In] Pointer to this layer's parameter structure. */
    phhalHw_Pn5190_Instr_CtsConfig_t
    *pCtsConfig      /**< [In] Pointer to CTS configuration data structure. */
);
...
phStatus_t phhalHw_Pn5190_Instr_GetVersion(
    ...
    *pDataParams,       /**< [In] Pointer to this layer's parameter structure. */
    phhalHw_Pn5190_Version_t
    *pVersion             /**< [InOut] structure pointer for, 4 byte Version Information read from PN5190. */
);
