...
/** @{ */
#define PHAL_MFDFEVX_GENERATE_DAMMAC_CREATE_APPLICATION                 0x00    /**< Option to indicate the DAMMAC generation is for \ref phalMfdfEVx_CreateDelegatedApplication command. */
#define PHAL_MFDFEVX_GENERATE_DAMMAC_DELETE_APPLICATION                 0x80    /**< Option to indicate the DAMMAC generation is for \ref phalMfdfEVx_DeleteApplication command. */
/** @} */
