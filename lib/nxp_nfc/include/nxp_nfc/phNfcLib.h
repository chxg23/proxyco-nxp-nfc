...
typedef struct {
  ...
  phNfcLib_ActivatedType_t
  dwActivatedType;                    /**< Activated type may be ORed value of \ref phNfcLib_ActivatedType_t. */
#if 0
...
typedef struct { /*phNfcLib_MFC*/
  phNfcLib_MFC_Commands_t
  bCommand;               /**< [In] MIFARE Classic command needs to be provided. */
...
typedef struct { /*phNfcLib_MFUL*/
  phNfcLib_MFUL_Commands_t
  bCommand;              /**< [In] MIFARE Ultralight command needs to be provided. */
...
typedef struct { /*phNfcLib_MFdf*/
  phNfcLib_MFDF_Commands_t
  bCommand;              /**< [In] MIFARE DESFire command needs to be provided. */
  union {
...
typedef struct { /*phNfcLib_I15693*/
  phNfcLib_I15693_Commands_t
  bCommand;            /**< [In] ISO-IEC 15693-3 command needs to be provided. */
...
typedef struct { /*phNfcLib_I18000p3m3*/
  phNfcLib_I18000_Commands_t
  bCommand;            /**< [In] ISO-IEC 18000-p3m3 command needs to be provided. */
...
phNfcLib_Status_t phNfcLib_SetContext(
    phNfcLib_AppContext_t
    *pAppContext      /**< [In] Pointers to phNfcLib_AppContext_t structure which provides the context to NFCLIB by Application. */
);
...
phNfcLib_Status_t phNfcLib_Activate(
    ...
    , /**< [Out] Pointer to a phNfcLib_PeerInfo_t structure, to be allocated by the caller.
                                                             On successful activation of a peer, activation procedure fills the structure
                                                             with detailed information. */
    pphNfcLib_ErrCallbck
    ErrCallbck /**< [In] Error callback specific to #PH_NFCLIB_ACTIVATION_PROFILE_EMVCO to intimate
...
phNfcLib_Status_t phNfcLib_Transmit(
    void *const
    pTxBuffer,      /**< [In] Byte array containing the data to be sent or \link phNfcLib_Transmit Metadata \endlink in ISO mode. */
...
phNfcLib_Status_t phNfcLib_Receive(
    uint8_t *const
    pRxBuffer,   /**< [Out] Allocated byte array to which the received data has to be written. */
...
phNfcLib_Status_t phNfcLib_SetConfig(
    ...
    const uint8_t
    *pConfigParam,    /**< [In] An array holding the value to be set for the given parameter. */
...
phNfcLib_Status_t phNfcLib_Deactivate(
    ...
    phNfcLib_PeerInfo_t
    *peerInfo    /**< [In] Pointer to a phNfcLib_PeerInfo_t structure updated by /ref phNfcLib_Activate API. */
);
