...
#define PH_NXPNFCRDLIB_CONFIG_VAS_TYPEA_GT                       780U     /**< Guard time configuration for VAS Type A poll in Micro seconds.*/
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
#define PH_NXPNFCRDLIB_CONFIG_EMVCO_OTHER_TECH_POLLING_FIELD_OFF_DELAY_US  5100U    /**< Wait time tP as per EMVCo specification. Simplified API EMVCo profile uses this value for Card removal procedure. */
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
