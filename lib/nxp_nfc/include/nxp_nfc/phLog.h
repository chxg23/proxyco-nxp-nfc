...
typedef void (*pphLog_Callback_t)(void *pDataParams, uint8_t bOption,
    phLog_LogEntry_t *pLogEntries, uint16_t wEntryCount);
...
typedef struct {
  ...
  phLog_RegisterEntry_t
  *pRegisterEntries;    /**< An array of \ref phLog_RegisterEntry_t structures. */
...
phStatus_t phLog_Init(
    ...
    phLog_RegisterEntry_t
    *pRegisterEntries,  /**< [In] An array of \ref phLog_RegisterEntry_t memory. */
