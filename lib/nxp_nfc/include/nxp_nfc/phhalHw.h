...
typedef struct {
  ...
  ppRFCallBck_t
  pRFISRCallback;                      /**< Application RF callback called by ISR handler. */
 ...
 * \retval #PH_ERR_SUCCESS Operation successful.
 */
phStatus_t phhalHw_PN7462AU_Init(phhalHw_PN7462AU_DataParams_t
    *pDataParams,  /**< [In] Pointer to this layer's parameter structure. */
 ...
 */
phStatus_t phhalHw_PN7462AU_SetListenParam(phhalHw_PN7462AU_DataParams_t
    *pDataParams,  /**< [In] Pointer to this layer's parameter structure. */
...
typedef struct {
  ...
  pRFISRCallback;                       /**< Application RF callback called by ISR handler. */
  ppTimerCallBck_t
  pTimerISRCallBack;                 /**< Guard timer callback called by ISR handler. */
...
phStatus_t phhalHw_Pn5180_Init(
    phhalHw_Pn5180_DataParams_t
    *pDataParams,                 /**<[In] Pointer to data parameter of this HAL layer */
    uint16_t wSizeOfDataParams,                               /**<[In] Size of the data parameter of the structure that was passed */
    void *pBalDataParams,                                     /**<[In] Pointer to the lower layer parameter(BAL) structure */
    void *pKeyStoreDataParams,                                /**< [In] Pointer to the parameter structure of the keyStore layer. */
...
typedef struct {
  ...
  phIrqResp_t
  sIrqResp;                               /**< Structure to be filled by ISR HAL Callback, contains minimal response read in ISR */
...
/**
 *  Gets or Set the Reader IC information. This will be helpful in Sam is connected in X mode.
 *  */
#define PHHAL_HW_CONFIG_SET_READER_IC       0x0022U
...
#ifdef NXPBUILD__PHHAL_HW_RC663
  phhalHw_Rc663_DataParams_t
  sHal;                       /* HAL component holder for Rc663 */
#endif /* NXPBUILD__PHHAL_HW_RC663 */
#ifdef NXPBUILD__PHHAL_HW_PN7462AU
  phhalHw_PN7462AU_DataParams_t
  sHal;                       /* HAL component holder for PN7462AU */
#endif /* NXPBUILD__PHHAL_HW_PN7462AU */
#ifdef NXPBUILD__PHHAL_HW_PN5180
  phhalHw_Pn5180_DataParams_t
  sHal;                       /* HAL component holder for Pn5180 */
#endif /* NXPBUILD__PHHAL_HW_PN5180 */

#ifdef NXPBUILD__PHHAL_HW_PN5190
  phhalHw_Pn5190_DataParams_t
  sHal;                       /* HAL component holder for Pn5190 */
#endif /* NXPBUILD__PHHAL_HW_PN5190 */
...
#include "../../src/comps/phhalHw/src/Rc663/phhalHw_Rc663.h"
...
#include "../../src/comps/phhalHw/src/Rc523/phhalHw_Rc523.h"
...
#include "../../src/comps/phhalHw/src/PN7462AU/phhalHw_PN7462AU.h"
...
#include "../../src/comps/phhalHw/src/Pn5180/phhalHw_Pn5180.h"
...
#include "../../src/comps/phhalHw/src/Pn5190/phhalHw_Pn5190.h"
...
phStatus_t phhalHw_SetConfigMultiple(
    ...
    uint16_t (
        *arr2dConfig) [PHHAL_HW_ARRY_COLUMNS_SIZE]/**< [In] Array Configuration identifier in form of key-value pair. */
);
