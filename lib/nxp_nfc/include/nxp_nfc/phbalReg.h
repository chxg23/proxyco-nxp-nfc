...
typedef struct {
  ...
  uint8_t
  bBalType;         /**< BAL type used by HAL to configure the BAL configured at runtime. */
} phbalReg_Type_t;
...
#define PHBAL_REG_TYPE_ISO7816              0x0006U /**< ISO7816 communication channel. */
