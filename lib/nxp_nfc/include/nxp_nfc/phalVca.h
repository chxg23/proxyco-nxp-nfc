...
typedef struct {
  ...
  phalVca_Sw_CardTableEntry_t
  *pCardTable;                                /**< Pointer to the Card Table of the layer. */
  phalVca_Sw_IidTableEntry_t
  *pIidTable;                                  /**< Pointer to the Iid Table of the layer. */
  ...
  phalVca_VirtualCardState
  eVCState;                                      /**< Enum variable holding Virtual Card state. */
  phalVca_ProximityCheckState
  ePCState;                                   /**< Enum Variable holding Proximity Check state. */
...
phStatus_t phalVca_Sw_Init(
    ...
    *pDataParams,                               /**< [In] Pointer to this layer's parameter structure. */
    ...
    phalVca_Sw_IidTableEntry_t
    *pIidTableStorage,                       /**< [In] Pointer to the Iid Table storage for the layer. */
    uint16_t wNumIidTableStorageEntries,                                /**< [In] Number of possible Iid table entries in the storage. */
    phalVca_Sw_CardTableEntry_t
    *pCardTableStorage,                     /**< [In] Pointer to the Card Table storage for the layer. */
