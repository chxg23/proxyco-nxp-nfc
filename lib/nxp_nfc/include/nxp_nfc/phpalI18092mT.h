...
typedef struct {
  ...
  pRtoxTimerCallback
  pRtoxCallback;                                  /**< Holds RTOX Callback function address */
...
phStatus_t phpalI18092mT_Sw_Init(
    ...
    *pDataParams,                        /**< [In] Pointer to this layer's parameter structure. */
    ...
    pRtoxTimerCallback
    pRtoxCallback                                   /**< [In] Callback to be executed by the RTOX timer. Implementation provided by user. */
);
...
#include "../../src/comps/phpalI18092mT/src/Sw/phpalI18092mT_Sw.h"
