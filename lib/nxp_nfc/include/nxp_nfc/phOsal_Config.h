...
*
* @def PH_OSAL_MYNEWT
*      Macro to Enable MyNewt Support
*/
/*@}*/
...
#include "../../src/comps/phOsal/src/mynewt/phOsal_mynewt.h"

#define PH_OSAL_CONFIG_MAX_NUM_TASKS       4U
#define PH_OSAL_CONFIG_MAX_NUM_EVENTS      10U
#define PH_OSAL_CONFIG_MAX_NUM_SEMAPHORE   10U
#define PH_OSAL_CONFIG_MAX_NUM_MUTEX       10U
#define PH_OSAL_CONFIG_MAX_NUM_TIMERS      10U

#endif /* PH_OSAL_MYNEWT */
