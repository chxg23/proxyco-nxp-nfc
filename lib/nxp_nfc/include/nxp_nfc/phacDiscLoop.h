...
*/
/*@{*/
#define PHAC_DISCLOOP_VAS_IN_COMPATIBILITY_MODE               0x01U   /**< Send VAS Command similar to PN7150 in Activity 1.0 mode. */
#define PHAC_DISCLOOP_VAS_IN_NFC_ACTIVITY_VERSION_1_1         0x02U   /**< Send VAS Command as proprietary polling in Activity 1.1 mode. */
/*@}*/
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
...
typedef struct {
  ...
  struct { /*phacDiscLoop_TypeF_Tag_Info*/
    uint8_t aIDmPMm[PHAC_DISCLOOP_FELICA_IDM_LENGTH +
                                        PHAC_DISCLOOP_FELICA_PMM_LENGTH]; /**< Manufacture ID + PMm. */
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
  /**
   * VAS Configuration mode.
   *
   * Use \ref phacDiscLoop_SetConfig with #PHAC_DISCLOOP_CONFIG_VAS_POLLING_IN_NFC_MODE option to
   * configure VAS polling in NFC mode.
   * */
  uint8_t bVASPollMode;
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
...
phStatus_t phacDiscLoop_Sw_Init(
    phacDiscLoop_Sw_DataParams_t
    *pDataParams,     /**< [In] Pointer to discovery loop parameter structure. */
 ...
 * mode.
 *
 * Default guard time is set to 780 microseconds for Type A.
 * */
...
#ifdef NXPBUILD__PHAC_DISCLOOP_SW_ECP
/**
 * Configure the VAS polling behavior in NFC Mode of Discovery Loop.
 *
 * #PHAC_DISCLOOP_VAS_IN_COMPATIBILITY_MODE       -> Send VAS Command similar to PN7150 in Activity 1.0 mode.\n
 * #PHAC_DISCLOOP_VAS_IN_NFC_ACTIVITY_VERSION_1_1 -> Send VAS Command as proprietary polling in Activity 1.1 mode.\n
 * */
#define PHAC_DISCLOOP_CONFIG_VAS_POLLING_IN_NFC_MODE          0x8EU
#endif /* NXPBUILD__PHAC_DISCLOOP_SW_ECP */
